# Part of NWOS. See LICENSE file for full copyright and licensing details.
...
!ifndef SERVICENAME
	!define SERVICENAME 'nwos-server-${VERSION}'
!endif
...
!define UNINSTALL_REGISTRY_KEY_SERVER "${UNINSTALL_BASE_REGISTRY_KEY}\NWOS Server ${VERSION}"
...
!define DEFAULT_NWOS_DB_USERNAME 'nwos'
!define DEFAULT_NWOS_DB_PASSWORD 'nwospwd'

Name '${DISPLAY_NAME}'
Caption "${PRODUCT_NAME} ${VERSION} Setup"
OutFile "${TOOLSDIR}\server\nwos_setup_${VERSION}.exe"
...
Var TextNWOSDBUsername
Var TextNWOSDBPassword

Var HWNDNWOSDBUsername
Var HWNDNWOSDBPassword
...
Page Custom ShowNWOSDB LeaveNWOSDB
...
!define MUI_FINISHPAGE_LINK_LOCATION "https://www.nwos.com/page/contactus"
...
; English
LangString DESC_NWOS_Server ${LANG_ENGLISH} "Install the NWOS Server with all the NWOS standard modules."
LangString DESC_PostgreSQL ${LANG_ENGLISH} "Install the PostgreSQL RDBMS used by NWOS."
LangString DESC_FinishPage_Link ${LANG_ENGLISH} "Contact NWOS for Partnership and/or Support"
LangString DESC_AtLeastOneComponent ${LANG_ENGLISH} "You have to choose at least one component"
LangString DESC_CanNotInstallPostgreSQL ${LANG_ENGLISH} "You can not install the PostgreSQL database without the NWOS Server"
...
LangString DESC_NWOSDBSection ${LANG_ENGLISH} "NWOS PostgreSQL User"
LangString DESC_NWOSDBPage ${LANG_ENGLISH} "Configure the NWOS PostgreSQL user credentials"
LangString DESC_NWOSDB_Username ${LANG_ENGLISH} "NWOS DB Username"
LangString DESC_NWOSDB_Password ${LANG_ENGLISH} "NWOS DB Password"
LangString WARNING_NWOSDBUsernameIsEmpty ${LANG_ENGLISH} "The NWOS database username cannot be empty"
LangString WARNING_NWOSDBPasswordIsEmpty ${LANG_ENGLISH} "The NWOS database password cannot be empty"
LangString WARNING_NWOSDBUsernameInvalid ${LANG_ENGLISH} "The NWOS database username must contain only letters, digits and underscores, and start with a letter or underscore"
LangString Profile_AllInOne ${LANG_ENGLISH} "NWOS Server And PostgreSQL Server"
LangString Profile_Server ${LANG_ENGLISH} "NWOS Server Only"
LangString Profile_IOT ${LANG_ENGLISH} "NWOS IoT"
LangString TITLE_NWOS_Server ${LANG_ENGLISH} "NWOS Server"
LangString TITLE_PostgreSQL ${LANG_ENGLISH} "PostgreSQL Database"
LangString TITLE_IOT ${LANG_ENGLISH} "NWOS IoT"
LangString TITLE_Nginx ${LANG_ENGLISH} "Nginx WebServer"
LangString TITLE_Ghostscript ${LANG_ENGLISH} "Ghostscript interpreter"
LangString DESC_FinishPageText ${LANG_ENGLISH} "Start NWOS"
LangString UnsafeDirText ${LANG_ENGLISH} "Installing outside of $PROGRAMFILES64 is not recommended.$\nDo you want to continue ?"

; French
LangString DESC_NWOS_Server ${LANG_FRENCH} "Installation du Serveur NWOS avec tous les modules NWOS standards."
LangString DESC_PostgreSQL ${LANG_FRENCH} "Installation de la base de données PostgreSQL utilisée par NWOS."
LangString DESC_FinishPage_Link ${LANG_FRENCH} "Contactez NWOS pour un Partenariat et/ou du Support"
LangString DESC_AtLeastOneComponent ${LANG_FRENCH} "Vous devez choisir au moins un composant"
LangString DESC_CanNotInstallPostgreSQL ${LANG_FRENCH} "Vous ne pouvez pas installer la base de données PostgreSQL sans le serveur NWOS"
...
LangString DESC_NWOSDBSection ${LANG_FRENCH} "Utilisateur NWOS PostgreSQL"
LangString DESC_NWOSDBPage ${LANG_FRENCH} "Configurez les identifiants de l'utilisateur NWOS pour PostgreSQL"
LangString DESC_NWOSDB_Username ${LANG_FRENCH} "Utilisateur NWOS"
LangString DESC_NWOSDB_Password ${LANG_FRENCH} "Mot de passe NWOS"
LangString WARNING_NWOSDBUsernameIsEmpty ${LANG_FRENCH} "Le nom d'utilisateur NWOS ne peut pas être vide"
LangString WARNING_NWOSDBPasswordIsEmpty ${LANG_FRENCH} "Le mot de passe NWOS ne peut pas être vide"
LangString WARNING_NWOSDBUsernameInvalid ${LANG_FRENCH} "Le nom d'utilisateur NWOS ne peut contenir que des lettres, chiffres et underscores, et doit commencer par une lettre ou un underscore"
LangString Profile_AllInOne ${LANG_FRENCH} "Serveur NWOS Et Serveur PostgreSQL"
LangString Profile_Server ${LANG_FRENCH} "Seulement Le Serveur NWOS"
LangString Profile_IOT ${LANG_FRENCH} "NWOS IoT"
LangString TITLE_NWOS_Server ${LANG_FRENCH} "Serveur NWOS"
LangString TITLE_PostgreSQL ${LANG_FRENCH} "Installation du serveur de base de données PostgreSQL"
LangString TITLE_IOT ${LANG_FRENCH} "NWOS IoT"
...
LangString DESC_FinishPageText ${LANG_FRENCH} "Démarrer NWOS"
...
Section $(TITLE_NWOS_Server) SectionNWOS_Server
    SectionIn 1 2 3
    ...
    # If there is a previous install of the NWOS Server, keep the login/password from the config file
    WriteIniStr "$INSTDIR\server\nwos.conf" "options" "db_host" $TextPostgreSQLHostname
    WriteIniStr "$INSTDIR\server\nwos.conf" "options" "db_user" $TextNWOSDBUsername
    WriteIniStr "$INSTDIR\server\nwos.conf" "options" "db_password" $TextNWOSDBPassword
    WriteIniStr "$INSTDIR\server\nwos.conf" "options" "db_port" $TextPostgreSQLPort
    # Fix the addons path
    WriteIniStr "$INSTDIR\server\nwos.conf" "options" "addons_path" "$INSTDIR\server\nwos\addons"
    WriteIniStr "$INSTDIR\server\nwos.conf" "options" "bin_path" "$INSTDIR\thirdparty"
    # Set data_dir
    WriteIniStr "$INSTDIR\server\nwos.conf" "options" "data_dir" "$INSTDIR\sessions"
...
Section $(TITLE_PostgreSQL) SectionPostgreSQL
    ...
    ExecWait '"$TEMP\$postgresql_exe_filename" \
        ...
        --servicename "PostgreSQL_For_NWOS" \
    ...
    DetailPrint "Creating NWOS database user with CREATEDB privilege"
    ${WordReplace} $TextNWOSDBPassword "'" "''" "+" $R0
    System::Call 'Kernel32::SetEnvironmentVariableW(w "PGPASSWORD", w "$TextPostgreSQLPassword")'
    nsExec::ExecToStack `"$INSTDIR\PostgreSQL\bin\psql.exe" -w -U "$TextPostgreSQLUsername" -h "$TextPostgreSQLHostname" -p $TextPostgreSQLPort -d postgres -c "CREATE ROLE $TextNWOSDBUsername WITH CREATEDB NOSUPERUSER NOCREATEROLE LOGIN PASSWORD '$R0'"`
    Pop $R1
    Pop $R2
    System::Call 'Kernel32::SetEnvironmentVariableW(w "PGPASSWORD", w "")'
    ${If} $R1 != 0
        DetailPrint "Failed to create NWOS database user (psql exit code $R1)"
    ${Else}
        DetailPrint "NWOS database user created successfully"
    ${EndIf}
SectionEnd
...
Section $(TITLE_IOT) IOT
    ...
    WriteIniStr "$INSTDIR\server\nwos.conf" "options" "server_wide_modules" "web,hw_posbox_homepage,hw_drivers"
    WriteIniStr "$INSTDIR\server\nwos.conf" "options" "list_db" "False"
    WriteIniStr "$INSTDIR\server\nwos.conf" "options" "max_cron_threads" "0"
    nsExec::ExecToStack '"$INSTDIR\python\python.exe" "$INSTDIR\server\nwos-bin" genproxytoken'
    pop $0
    pop $ProxyTokenPwd
SectionEnd
...
Section $(TITLE_Nginx) Nginx
    ...
    File "..\..\nwos\addons\point_of_sale\tools\posbox\overwrite_after_init\etc\ssl\certs\nginx-cert.crt"
    File "..\..\nwos\addons\point_of_sale\tools\posbox\overwrite_after_init\etc\ssl\private\nginx-cert.key"
SectionEnd
...
Section -Post
    ...
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "HelpLink" "support@nwos.com"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "HelpTelephone" "+32.81.81.37.00"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "URLInfoAbout" "https://www.nwos.com"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "Contact" "sales@nwos.com"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
    !insertmacro MUI_DESCRIPTION_TEXT ${SectionNWOS_Server} $(DESC_NWOS_Server)
...
Function .onInit
    ...
    ${If} $previous_install_dir == ""
        StrCpy $INSTDIR "$PROGRAMFILES64\NWOS ${VERSION}"
    ...
    StrCpy $TextNWOSDBUsername ${DEFAULT_NWOS_DB_USERNAME}
    StrCpy $TextNWOSDBPassword ${DEFAULT_NWOS_DB_PASSWORD}
    ...
    System::Call 'Kernel32::SetEnvironmentVariableW(w "PGPASSWORD", w "${DEFAULT_NWOS_DB_PASSWORD}")'
    nsExec::ExecToStack `"$R6\bin\psql.exe" -w -U "${DEFAULT_NWOS_DB_USERNAME}" -h "${DEFAULT_POSTGRESQL_HOSTNAME}" -p ${DEFAULT_POSTGRESQL_PORT} -d postgres -tAc "SELECT 1"`
    Pop $R7
    Pop $R8
    System::Call 'Kernel32::SetEnvironmentVariableW(w "PGPASSWORD", w "")'

    ${If} $R7 != 0
        StrCpy $TextNWOSDBUsername "${DEFAULT_POSTGRESQL_USERNAME}"
        StrCpy $TextNWOSDBPassword "${DEFAULT_POSTGRESQL_PASSWORD}"
    ${EndIf}
...
Function ShowNWOSDB
    GetCurInstType $R0
    IntCmp $R0 1 bypassNWOSDBConfig
    IntCmp $R0 2 bypassNWOSDBConfig

    ${If} $HasPostgreSQL == 1
        Goto bypassNWOSDBConfig
    ${EndIf}
    ...
    ${NSD_CreateLabel} 0 0 100% 10u $(DESC_NWOSDBPage)
    Pop $0

    ${NSD_CreateLabel} 0 45 90u 12u $(DESC_NWOSDB_Username)
    Pop $0
    ${NSD_CreateText} 130 45 130u 12u $TextNWOSDBUsername
    Pop $HWNDNWOSDBUsername

    ${NSD_CreateLabel} 0 75 90u 12u $(DESC_NWOSDB_Password)
    Pop $0
    ${NSD_CreateText} 130 75 130u 12u $TextNWOSDBPassword
    Pop $HWNDNWOSDBPassword

    nsDialogs::Show
    bypassNWOSDBConfig:
FunctionEnd

Function LeaveNWOSDB
    ${NSD_GetText} $HWNDNWOSDBUsername $TextNWOSDBUsername
    ${NSD_GetText} $HWNDNWOSDBPassword $TextNWOSDBPassword

    StrLen $1 $TextNWOSDBUsername
    ${If} $1 == 0
        MessageBox MB_ICONEXCLAMATION|MB_OK $(WARNING_NWOSDBUsernameIsEmpty)
        Abort
    ${EndIf}

    ${StrFilter} $TextNWOSDBUsername "12" "_" "" $R0
    ${If} $R0 != $TextNWOSDBUsername
        MessageBox MB_ICONEXCLAMATION|MB_OK $(WARNING_NWOSDBUsernameInvalid)
        Abort
    ${EndIf}

    StrCpy $R1 $TextNWOSDBUsername 1
    ${StrFilter} $R1 "1" "" "" $R2
    ${If} $R1 == $R2
        MessageBox MB_ICONEXCLAMATION|MB_OK $(WARNING_NWOSDBUsernameInvalid)
        Abort
    ...
    StrLen $1 $TextNWOSDBPassword
    ${If} $1 == 0
        MessageBox MB_ICONEXCLAMATION|MB_OK $(WARNING_NWOSDBPasswordIsEmpty)
        Abort
    ${EndIf}
FunctionEnd
...
Function ShowProxyTokenDialogPage
    ...
    doProxyToken:
        ...
        ${NSD_CreateLabel} 0 0 100% 25% "Here is your access token for the NWOS IOT, please write it down in a safe place, you will need it to configure the IOT"
        Pop $ProxyTokenLabel
...
Function ComponentLeave
    SectionGetFlags ${SectionNWOS_Server} $0
...
Function RestartNWOSService
    DetailPrint "Restarting NWOS Service"
