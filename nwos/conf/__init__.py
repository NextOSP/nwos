...
For now, configuration code is in nwos.tools.config. It is in mainly
...
To initialize properly this module, nwos.tools.config.parse_config()
must be used.

"""

# Paths to search for NWOS addons.
addons_paths = []
...
# installed (i.e. the majority of NWOS addons). This is set with the --load
# command-line option.
server_wide_modules = []
