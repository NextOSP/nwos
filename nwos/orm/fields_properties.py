...
from nwos.exceptions import AccessError, UserError, MissingError
from nwos.tools import SQL, OrderedSet, is_list_of, html_sanitize
from nwos.tools.misc import frozendict, has_list_types
...
class Properties(Field):
    ...
    like NWOS fields but without being independently stored in database.
    ...
    current record. The container must have a :class:`~nwos.fields.PropertiesDefinition`
...
class PropertiesDefinition(Field):
    """ Field used to define the properties definition (see :class:`~nwos.fields.Properties`
