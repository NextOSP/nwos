...
"""The NWOS API module defines NWOS Environments.
"""
...
from nwos.exceptions import AccessError, UserError, CacheMiss
from nwos.sql_db import BaseCursor
from nwos.tools import clean_context, frozendict, reset_cached_properties, OrderedSet, Query, SQL
from nwos.tools.translate import get_translation, get_translated_module, LazyGettext
from nwos.tools.misc import StackMap, SENTINEL
...
_logger = logging.getLogger('nwos.api')
...
class Environment(Mapping[str, "BaseModel"]):
    ...
    def __call__(
        ...
        :type cursor: :class:`~nwos.sql_db.Cursor`
    ...
    def user(self) -> BaseModel:
        ...
        :rtype: :class:`res.users record<~nwos.addons.base.models.res_users.ResUsers>`"""
    ...
    def company(self) -> BaseModel:
        ...
        :rtype: :class:`res.company record<~nwos.addons.base.models.res_company.Company>`
    ...
    def companies(self) -> BaseModel:
        ...
        :rtype: :class:`res.company recordset<~nwos.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry: Registry):
        ...
        # temporary directories (managed in nwos.tools.file_open_temporary_directory)
