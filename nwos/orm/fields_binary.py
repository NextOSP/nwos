...
from nwos.tools import SQL, human_size
...
class Binary(Field):
    ...
    def convert_to_column(self, value, record, values=None, validate=True):
        ...
        # the legacy NWOS convention is to transfer and store binaries
...
class Image(Binary):
    ...
    :param bool verify_resolution: whether the image resolution should be verified
        ...
        See :class:`nwos.tools.image.ImageProcess` for maximum image resolution (default: ``50e6``).
    ...
    def _image_process(self, value, env):
        ...
        from nwos.tools.image import image_process  # noqa: PLC0415
