...
from nwos.netsvc import COLOR_PATTERN, DEFAULT, GREEN, RED, ColoredFormatter
from nwos.tools import SQL, html_normalize, html_sanitize, html2plaintext, is_html_empty, plaintext2html, sql
from nwos.tools.misc import OrderedSet, SENTINEL, Sentinel
from nwos.tools.sql import pattern_to_translated_trigram_pattern, pg_varchar, value_to_translated_trigram_pattern
from nwos.tools.translate import html_translate
...
class Html(BaseString):
    ...
    def _get_attrs(self, model_class, name):
        ...
        # we do not need this Microsoft Outlook client feature for emails displayed NWOS's web client.
