...
"""The NWOS API module defines method decorators.
"""
...
def constrains(*args) -> Decorator:
    ...
    Should raise :exc:`~nwos.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall: bool) -> Decorator:
    """
    Mark a method to be executed during :meth:`~nwos.models.BaseModel.unlink`.
...
def onchange(*args: str) -> Decorator:
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/nwos/nwos/issues/2693>`_.
...
def autovacuum(method: C) -> C:
    ...
    as in :meth:`~nwos.addons.base.models.ir_cron.IrCron._commit_progress`.
    """
