...
NWOS domain strings, conditions and expressions, mostly based on locals
...
_BUBBLEUP_EXCEPTIONS = (
    nwos.exceptions.ConcurrencyError,  # let retrying handle this error
    nwos.exceptions.UserError,
    nwos.exceptions.RedirectWarning,
...
`nwos.tools.safe_eval.wrap_module` to generate a wrapper recursively
whitelisting allowed attributes.

Pre-wrapped modules are provided as attributes of `nwos.tools.safe_eval`.
""")
    return d
...
from nwos._monkeypatches.pytz import patch_module as patch_pytz  # noqa: E402, F401
patch_pytz()
