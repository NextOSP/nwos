# -*- coding: utf-8 -*-
"""
The module :mod:`nwos.tests.form` provides an implementation of a client form
...
class Form:
    ...
    * properly handle defaults & onchanges around x2many fields.
    ...
    of :class:`~nwos.fields.Many2one` fields, one can assign a recordset::
    ...
    For :class:`~nwos.fields.Many2many` fields, the field itself is a
    :class:`~nwos.tests.common.M2MProxy` and can be altered by adding or
    removing records::
    ...
    Finally :class:`~nwos.fields.One2many` are reified as :class:`~O2MProxy`.

    Because the :class:`~nwos.fields.One2many` only exists through its parent,
...
class O2MProxy(X2MProxy):
    ...
    def new(self):
        ...
        :class:`~nwos.fields.One2many` record, properly initialised.
    ...
    def edit(self, index):
        ...
        :class:`~nwos.fields.One2many` record.
