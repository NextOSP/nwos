...
NWOS_TEST_MAX_FAILED_TESTS = max(1, int(os.environ.get('NWOS_TEST_MAX_FAILED_TESTS', sys.maxsize)))

stats_logger = logging.getLogger('nwos.tests.stats')
...
class NWOSTestResult(object):
    ...
    def _checkShouldStop(self):
        if self.total_errors_count() >= NWOS_TEST_MAX_FAILED_TESTS:
            ...
            if not global_report.shouldStop:
                _logger.error(
                    ...
                    "Remaining tests will be skipped.", NWOS_TEST_MAX_FAILED_TESTS)
