...
term representation was ['=', 'company_id.name', 'NWOS']. Used in a
...
NWOS will use the SQL function 'unaccent' when available for the
...
Finally, to instruct NWOS to really use the unaccent function, you have to
...
import nwos.orm.domains as orm_domains
import nwos.modules
from nwos.tools import Query, SQL
...
def normalize_domain(domain):
    ...
    """
    warnings.warn("Since 19.0, use nwos.fields.Domain", DeprecationWarning)
...
def get_unaccent_wrapper(cr):
    ...
    return nwos.modules.registry.Registry(cr.dbname).unaccent
