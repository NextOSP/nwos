...
from nwos.modules import get_module_path
from nwos.modules.registry import Registry
from nwos.tools import OrderedSet, config
from nwos.tools.translate import TranslationImporter, load_language, trans_export
    ...
    def __init__(self, *args, **kwargs):
        ...
        for parser in (self.import_parser, self.export_parser, self.loadlang_parser):
            ...
            parser.epilog = textwrap.dedent("""\
                ...
                Examples:
                    nwos-bin i18n loadlang -l en         # English (U.S.)
                    nwos-bin i18n loadlang -l es es_AR   # Spanish (Spain, Argentina)
                    nwos-bin i18n loadlang -l sr@latin   # Serbian (Latin)
            """)
