...
from nwos.modules.module import Manifest, MANIFEST_NAMES
from nwos.service.db import _create_empty_database, DatabaseExists
from nwos.tools import config


class Start(Command):
    """ Quickly start the nwos server with default options """
