...
product_name = 'NWOS'
description = 'NWOS Server'
long_desc = '''NWOS is a complete ERP and CRM. The main features are accounting (analytic
...
author = 'NWOS'
author_email = 'info@nwos.com'
license = 'LGPL-3'

nt_service_name = "nwos-server-" + series.replace('~', '-')
