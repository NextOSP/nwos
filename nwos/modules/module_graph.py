...
from nwos.tools import reset_cached_properties, OrderedSet
...
class ModuleNode:
    """
    Loading and upgrade info for an NWOS module
    """
...
class ModuleGraph:
    """
    Sorted NWOS modules ordered by (module.phase, module.depth, module.name)
    """
