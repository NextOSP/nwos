...
from nwos import api, http
from nwos.exceptions import (
    AccessDenied,
    AccessError,
    ConcurrencyError,
    UserError,
...
from nwos.tools.safe_eval import _UNSAFE_ATTRIBUTES
...
def retrying(func, env):
    ...
    :param nwos.api.Environment env: The environment where the registry
