...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/nwos/action-test_orm.action_discussions",
            'widget_x2many', login="admin", timeout=120)


@nwos.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(nwos.tests.HttpCase):

    @mute_logger('nwos.sql_db', 'nwos.http')
    def test_01_sql_constraints(self):
        ...
        self.start_tour("/nwos/action-test_orm.action_categories",
