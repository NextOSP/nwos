...
from nwos.tests import Form, TransactionCase, users
from nwos.tools import get_lang, mute_logger
...
class PropertiesCase(TestPropertiesMixin):
    ...
    @mute_logger('nwos.models.unlink', 'nwos.fields')
    ...
    @users('test')
    @mute_logger('nwos.addons.base.models.ir_rule', 'nwos.fields')
    ...
    def test_properties_field_security(self):
        ...
        self.env.invalidate_all()
        with patch('nwos.addons.test_orm.models.test_orm.TestOrmMultiTag.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        ...
        self.env.invalidate_all()
        with patch('nwos.addons.test_orm.models.test_orm.TestOrmDiscussion.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        self.assertEqual(values['value'], (tag.id, 'Test Tag'))
...
class PropertiesGroupByCase(TestPropertiesMixin):
    ...
    @mute_logger('nwos.fields', 'nwos.models.unlink')
