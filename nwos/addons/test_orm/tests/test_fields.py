...
%endif"""
    ...
    @mute_logger('nwos.addons.base.models.ir_model')
    ...
    def test_85_binary_guess_zip(self):
        from nwos.addons.base.tests.test_mimetypes import ZIP  # noqa: PLC0415
    ...
    def test_86_text_base64_guess_svg(self):
        from nwos.addons.base.tests.test_mimetypes import SVG  # noqa: PLC0415
...
%endif"""
    ...
    @patch('nwos.orm.fields_textual.html_sanitize', return_value='<p>comment</p>')
...
class TestSelectionOndeleteAdvanced(TransactionCase):
    ...
    def test_ondelete_unexisting_policy(self):
        from nwos.orm.model_classes import add_to_registry  # noqa: PLC0415
...
class TestFieldParametersValidation(TransactionCase):
    def test_invalid_parameter(self):
        ...
        with self.assertLogs('nwos.fields', level='WARNING') as cm:
            self.registry._setup_models__(self.env.cr, [])  # incremental setup

        self.assertTrue(cm.output[0].startswith(
            "WARNING:nwos.fields:Field test_orm.field_parameter_validation.name: "
...
class TestUnlinkConstraints(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        from nwos.addons.base.models.ir_model import (  # noqa: PLC0415
