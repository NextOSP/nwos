...
from nwos.tools.mimetypes import _nwos_guess_mimetype, guess_mimetype
...
class TestMimeGuessingNWOS(BaseCase, MimeGuessingCases):
    guess_mimetype = staticmethod(_nwos_guess_mimetype)
...
@unittest.skipIf(guess_mimetype is _nwos_guess_mimetype, "python-magic not installed")
