...
import nwos
from nwos import api, http, models, tools
from nwos.api import SUPERUSER_ID
from nwos.exceptions import AccessDenied
from nwos.http import ROUTING_KEYS, SAFE_HTTP_METHODS, Response, request
from nwos.modules.registry import Registry
from nwos.service import security
from nwos.tools.json import json_default
from nwos.tools.misc import get_lang, submap
from nwos.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and nwos.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (nwos.exceptions.AccessError, nwos.exceptions.MissingError) as e:
                ...
                if request.env.user.is_public or isinstance(e, nwos.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(nwos.tools.config['server_wide_modules'])
    ...
    def _gc_sessions(self):
        if os.getenv("NWOS_SKIP_GC_SESSIONS"):
            return
