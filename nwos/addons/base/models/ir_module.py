...
from nwos.exceptions import AccessDenied, UserError, ValidationError
from nwos.fields import Domain
from nwos.tools import config
from nwos.tools.parse_version import parse_version
from nwos.tools.misc import topological_sort, get_flag
from nwos.tools.translate import TranslationImporter, get_po_paths, get_datafile_translation_path
from nwos.http import request
from nwos.modules.module import Manifest, MissingDependency
...
class IrModuleModule(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'NWOS Enterprise Edition License v1.0'),
        ('OPL-1', 'NWOS Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('NWOS Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        if self.search_count([('state', 'in', ('to install', 'to upgrade', 'to remove'))], limit=1):
            raise UserError(_("NWOS is currently processing another module operation.\n"
        ...
        try:
            ...
            self.env.cr.rollback()
            raise UserError(_("NWOS is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(nwos.tools.config['server_wide_modules']) & set(self.mapped('name'))
