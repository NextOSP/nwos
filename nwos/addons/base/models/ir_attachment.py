...
from nwos.http import Stream, request, root
...
from nwos.tools.mimetypes import (
    MIMETYPE_HEAD_SIZE,
    _olecf_mimetypes,
    fix_filename_extension,
    guess_mimetype,
)
from nwos.tools.misc import limited_field_access_token
...
class IrAttachment(models.Model):
    """Attachments are used to link binary files or url to any nwos document.
