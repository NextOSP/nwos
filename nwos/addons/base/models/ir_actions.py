...
from nwos.tools import _, frozendict, get_lang
from nwos.tools.float_utils import float_compare
from nwos.tools.misc import get_diff, unquote
from nwos.tools.safe_eval import safe_eval, test_python_expr
from nwos.tools.json import stringify_keys
...
class IrActionsServer(models.Model):
    ...
    Since NWOS 8.0 a button 'Create Menu Action' button is available on the
