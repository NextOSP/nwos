...
from nwos.exceptions import MissingError, UserError
from nwos.http import Stream, request
from nwos.tools import file_open, replace_exceptions
from nwos.tools.image import image_guess_size_from_field_name, image_process
from nwos.tools.mimetypes import MIMETYPE_HEAD_SIZE, get_extension, guess_mimetype
from nwos.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:nwos.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~nwos.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`nwos.tools.image.image_process`.
