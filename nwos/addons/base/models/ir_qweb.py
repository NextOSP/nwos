...
QWeb is the primary templating engine used by NWOS. It is an XML templating
...
<https://www.nwos.com/documentation/master/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed nwos user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``has_group`` NWOS method from ``res.users`` model.
...
from nwos.modules.registry import _REGISTRY_CACHES
from nwos.tools import config, safe_eval, OrderedSet, frozendict, json
from nwos.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from nwos.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from nwos.tools.lru import LRU
from nwos.tools.misc import str2bool, file_open, file_path
from nwos.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from nwos.tools.profiler import ExecutionContext
from nwos.tools.translate import FORMAT_REGEX
from nwos.http import request
from nwos.tools.profiler import QwebTracker
from nwos.exceptions import UserError, MissingError

from nwos.addons.base.models.assetsbundle import AssetsBundle
from nwos.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _render_iterall(self, view_ref, method, values, directive='render') -> Iterator[str]:
        ...
        try:
            ...
            if hasattr(error, 'qweb'):
                ...
                # If is not an nwos Exception check if the current error is raise from
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since NWOS 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__nwosAssetError=1"
