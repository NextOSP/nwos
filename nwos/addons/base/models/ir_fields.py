...
from nwos import api, Command, fields, models
from nwos.tools import OrderedSet
from nwos.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str, *, savepoint):
        ...
        callable taking a record-ish (a dictionary representing an nwos
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`nwos.models.Model.write` expects.

        :param model: :class:`nwos.models.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str, *, savepoint):
        ...
        :type field: :class:`nwos.fields.Field`
