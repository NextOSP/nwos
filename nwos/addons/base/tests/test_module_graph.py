...
class TestGraph(BaseCase):
    @mute_logger('nwos.modules.module_graph')
    def _test_graph_order(
        ...
        with (
            patch('nwos.modules.module_graph.ModuleGraph._update_from_database'),
            patch('nwos.modules.module_graph.Manifest.for_addon', make_manifest),
            patch('nwos.modules.module_graph.ModuleGraph._imported_modules', {'studio_customization'}),
        ):
            dummy_cr = None
