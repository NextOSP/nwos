...
import nwos
from nwos.exceptions import UserError, ValidationError, AccessError
from nwos.tools import mute_logger, frozendict
from nwos.tests import common, tagged
from nwos.addons.base.tests.common import TransactionCaseWithUserDemo
from nwos.addons.base.models.res_partner import ResPartner
...
class TestServerActions(TestServerActionsBase):
    def test_00_server_action(self):
        with self.assertLogs('nwos.addons.base.models.ir_actions.server_action_safe_eval',
                             level='DEBUG') as log_catcher:
            self.test_server_action.run()
            self.assertEqual(log_catcher.output, [
                'DEBUG:nwos.addons.base.models.ir_actions.server_action_safe_eval:This is a test debug log',
                'INFO:nwos.addons.base.models.ir_actions.server_action_safe_eval:This is a test info log',
                'WARNING:nwos.addons.base.models.ir_actions.server_action_safe_eval:This is a test warning log',
                'ERROR:nwos.addons.base.models.ir_actions.server_action_safe_eval:This is a test error log',
"""ERROR:nwos.addons.base.models.ir_actions.server_action_safe_eval:This is a test exception log
...
ZeroDivisionError: division by zero""" % self.test_server_action.id
    ...
    @mute_logger('nwos.addons.base.models.ir_model', 'nwos.models')
    ...
    @mute_logger('nwos.addons.base.models.ir_actions')
    ...
    def test_90_webhook(self):
        ...
        with patch.object(requests, 'post', _patched_post), mute_logger('nwos.addons.base.models.ir_actions'):
            # first run: 200
            self.action.with_context(self.context).run()
...
class TestCustomFields(TestCommonCustomFields):
    def test_create_custom(self):
        ...
        with self.assertRaises(IntegrityError), mute_logger('nwos.sql_db'):
    ...
    @mute_logger('nwos.addons.base.models.ir_ui_view')
...
class TestCustomFieldsPostInstall(TestCommonCustomFields):
    ...
    def test_add_field_valid(self):
        ...
        with self.assertLogs('nwos.registry') as log_catcher:
