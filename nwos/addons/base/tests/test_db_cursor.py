...
from nwos.tests.common import BaseCase, HttpCase
from nwos.tests.test_cursor import TestCursor
from nwos.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('nwos.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:nwos.sql_db:Found different un-closed cursor', msg)
