...
from nwos.tools.pdf.signature import PdfSigner
...
class TestSignature(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cert_subject = x509.Name([
            ...
            x509.NameAttribute(NameOID.ORGANIZATION_NAME, "NWOS"),
            x509.NameAttribute(NameOID.COMMON_NAME, "nwos.com")
        ])
