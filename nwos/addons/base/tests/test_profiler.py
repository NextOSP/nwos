...
from nwos.tests.common import BaseCase, TransactionCase, tagged, new_test_user, HttpCase
from nwos.tools import profiler
from nwos.tools.profiler import Profiler, ExecutionContext
from nwos.tools.speedscope import Speedscope
...
class TestProfiling(TransactionCase):
    ...
    def test_profiler_return(self):
        ...
        self.startClassPatcher(patch('nwos.sql_db.db_connect', return_value=self.registry))
