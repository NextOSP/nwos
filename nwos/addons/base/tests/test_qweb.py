...
from nwos.addons.base.models.ir_qweb import QWebError
from nwos.tools import file_open, misc, mute_logger
from nwos.tools.json import scriptsafe as json_scriptsafe
from nwos.exceptions import UserError, MissingError
...
class TestQWebNS(TransactionCase):
    ...
    def test_render_dynamic_xml_with_code_error(self):
        ...
        view1 = self.env['ir.ui.view'].create({
            ...
            'arch': """
                <t t-name="base.dummy">
                    <Invoice xmlns:od="http://nwos.com/od">
...
class TestQWebBasic(TransactionCase):
    ...
    def test_attf_escaping_2(self):
        ...
        result = """
                <a href="/link/nwos/sub">link</a>
                <a href="/link/nwos/">link2</a>
            """
        values = {'url': 'nwos', 'other': True}
        rendered = self.env['ir.qweb']._render(t.id, values)
        self.assertEqual(rendered.strip(), result.strip())
    ...
    @mute_logger('nwos.addons.base.models.ir_qweb')
    ...
    @mute_logger('nwos.addons.base.models.ir_qweb') # warning for template not found
