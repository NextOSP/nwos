...
from nwos.tests.common import standalone
from nwos.tests.test_module_operations import install
from nwos.tools import mute_logger
from nwos.tools.convert import ParseError
...
def test_isolated_install(env):
    ...
    try:
        with mute_logger('nwos.modules.registry'):
