...
from nwos import Command, models
from nwos.addons.base.models.ir_mail_server import extract_rfc2822_addresses
...
from nwos.tests.common import new_test_user, tagged, TransactionCase, users, warmup
...
class TestPartner(TransactionCaseWithUserDemo):
    ...
    def test_main_user_id(self):
        """Test main_user_id compute, including NWOSBot special case and priority among several users."""
