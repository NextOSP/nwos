...
from nwos.tests import BaseCase, TransactionCase, tagged, BaseCase
from nwos.tests.suite import _logger as test_logger
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when NWOS_TEST_FAILURE_RETRIES is set"""
