...
from nwos.exceptions import AccessDenied, UserError
from nwos.http import request
from nwos.tools.misc import babel_locale_parse, hmac

from nwos.addons.auth_totp.models.totp import hotp, TOTP
...
class ResUsers(models.Model):
    ...
    def get_totp_invite_url(self):
        return '/nwos/action-auth_totp_mail.action_activate_two_factor_authentication'
