...
from nwos.tests import get_db_name, tagged, HttpCase
...
class TestTOTPMail(TestTOTPMixin, HttpCase):
    ...
    def test_totp_rpc_api_keys_only(self):
        ...
        with (
            ...
            self.assertLogs(logger='nwos.addons.base.models.res_users') as log_catcher,
...
class TestTOTPInvite(TestTOTPMixin, HttpCase):
    ...
    def test_totp_administration(self):
        ...
        self.start_tour('/nwos', 'totp_admin_invite', login='admin')
        self.start_tour('/nwos', 'totp_admin_self_invite', login='admin')
