...
from nwos.addons.account.tests.test_taxes_downpayment import TestTaxesDownPayment
from nwos.addons.point_of_sale.tests.test_frontend import TestTaxCommonPOS
from nwos.addons.sale.tests.common import TestTaxCommonSale
