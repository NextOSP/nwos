...
from nwos import api, http, SUPERUSER_ID, _
from nwos.exceptions import AccessDenied
from nwos.http import fragment_to_query_string, request
from nwos.modules.registry import Registry
from nwos.tools.misc import clean_context

from nwos.addons.auth_signup.controllers.main import AuthSignupHome as Home
from nwos.addons.web.controllers.utils import ensure_db, _get_login_redirect_url
...
class OAuthController(http.Controller):
    ...
    def signin(self, **kw):
        ...
        try:
            ...
            if redirect:
                ...
                url = '/nwos/action-%s' % action
            elif menu:
                url = '/nwos?menu_id=%s' % menu
    ...
    def oea(self, **kw):
        """login user via NWOS Account provider"""
        ...
        with registry.cursor() as cr:
            try:
                ...
                provider = env.ref('auth_oauth.provider_nwos')
            except ValueError:
