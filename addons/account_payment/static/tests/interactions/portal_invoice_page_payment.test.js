...
import { advanceTime, queryOne } from "@nwos/hoot-dom";
            ...
            <div class="container mt-3">
                <div class="alert alert-info alert-dismissible fade show d-print-none css_editable_mode_hidden">
                    <div class="text-center">
                        ...
                        <a class="alert-link" href="/nwos/action-account.action_move_out_invoice_type/2"><i class="oi oi-arrow-right me-1"></i>Back to edit mode</a>
                    </div>
                            ...
                            <div class="d-flex col-lg-4 col-xxl-3 d-print-none">
                                <div class="o_portal_sidebar_content flex-grow-1 mb-4 mb-lg-0 pe-lg-4" id="sidebar_content">
                                    ...
                                    <div class="d-none d-lg-block mt-5 small text-center text-muted" data-oe-model="ir.ui.view" data-oe-id="549" data-oe-field="arch" data-oe-xpath="/t[1]/div[1]/div[1]/div[2]">
                                        Powered by <a target="_blank" href="https://www.nwos.com?utm_source=db&amp;utm_medium=portal" title="nwos"><img src="/web/static/img/logo.png" alt="NWOS Logo" height="15" loading="lazy" style=""></a>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="alert alert-warning mt-2">
                                                            ...
                                                            <div class="mt-2">
                                                                ...
                                                                <a
                                                                    ...
                                                                    href="/nwos/action-payment.action_start_payment_onboarding"
                                                                    role="button"
                                                                ...
                                                                <a role="button" type="action" class="btn-link alert-warning me-2" href="/nwos/action-payment.action_payment_provider" data-oe-model="ir.ui.view" data-oe-id="612" data-oe-field="arch" data-oe-xpath="/t[1]/div[1]/div[2]/a[3]">
