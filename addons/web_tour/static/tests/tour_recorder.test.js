...
import { click, edit, keyDown, keyUp, press, queryOne } from "@nwos/hoot-dom";
...
test("Click on element with unique nwos class", async () => {
...
test("Click on element with no unique nwos class", async () => {
    await mountWithCleanup(
        `
        <div class="o_parent">
            <div class="o_child_1 click"></div>
...
test("Find the nearest nwos class", async () => {
