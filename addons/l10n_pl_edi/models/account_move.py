...
from nwos import Command, api, fields, models
from nwos.exceptions import UserError
from nwos.tools import float_compare, float_is_zero, float_repr, mute_logger, OrderedSet
...
class AccountMove(models.Model):
    ...
    def _l10n_pl_edi_get_status_mapping(self):
        """
        Returns a dictionary mapping KSeF status codes to (nwos_status, message).
        """
        return {
    ...
    def _fetch_bills_data(self, service, bills_to_fetch):
        for bill in bills_to_fetch:
            ...
            try:
                ...
                with mute_logger('nwos.sql_db'), self.env.cr.savepoint():
                    bill.write({
