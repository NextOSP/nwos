...
from nwos.addons.auth_signup.models.res_partner import ResPartner
from nwos.addons.mail.tests.common import MailCommon
from nwos.addons.test_mail_full.tests.common import TestMailFullCommon
from nwos.addons.test_mail_sms.tests.common import TestSMSRecipients
from nwos.exceptions import AccessError
from nwos.tests import tagged, users
from nwos.tests.common import HttpCase
from nwos.tools import html_escape, mute_logger
...
class TestPortalControllers(TestPortal):
    ...
    def test_portal_share_comment(self):
        ...
        # Only messages from the current user not NWOSBot
...
class TestPortalFlow(MailCommon, HttpCase):
    ...
    def setUpClass(cls):
        ...
        cls.internal_backend_local_url = f'/nwos/{cls.record_internal._name}/{cls.record_internal.id}'
        cls.portal_backend_local_url = f'/nwos/{cls.record_portal._name}/{cls.record_portal.id}'
        cls.read_backend_local_url = f'/nwos/{cls.record_read._name}/{cls.record_read.id}'
        cls.public_act_url_backend_local_url = f'/nwos/{cls.record_public_act_url._name}/{cls.record_public_act_url.id}'
        cls.discuss_local_url = '/nwos/action-mail.action_discuss'
