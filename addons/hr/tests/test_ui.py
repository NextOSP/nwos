...
from nwos.tests import HttpCase, freeze_time, tagged, new_test_user
...
class TestEmployeeUi(HttpCase):
    def test_employee_profile_tour(self):
        ...
        self.start_tour("/nwos", 'hr_employee_tour', login="davidelora")
    ...
    def test_version_timeline_auto_save_tour(self):
        ...
        self.start_tour("/nwos", 'version_timeline_auto_save_tour', login="alice")
