NWOS Human Resources
--------------------

With NWOS <a href="https://www.nwos.com/app/employees">Human Resources</a>,
...
Index resumes, track applicants, search profiles with <a href="https://www.nwos.com/app/employees">NWOS HR</a>.
...
Get rid of the paper work and follow employee's expenses directly in NWOS.
...
evolution. Define steps for interviews and NWOS will notify managers or
...
createdb nwos
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -i hr
```
...
```bash
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -u hr
```
