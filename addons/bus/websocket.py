...
import nwos
from nwos import api, modules
from .models.bus import dispatch
from .tools import orjson
from nwos.http import root, Request, Response, SessionExpiredException, get_default_session
from nwos.modules.registry import Registry
from nwos.service import model as service_model
from nwos.service.server import CommonServer
from nwos.service.security import check_session
...
class Websocket:
    ...
    def __init__(self, sock, session, cookies):
        ...
        self.__selector = (
            ...
            if nwos.evented and hasattr(selectors, 'PollSelector')
...
class WebsocketConnectionHandler:
    ...
    def _handle_public_configuration(cls, request):
        if not os.getenv('NWOS_BUS_PUBLIC_SAMESITE_WS'):
            return
