import { after, expect, registerDebugInfo } from "@nwos/hoot";
import { Deferred } from "@nwos/hoot-mock";
import {
    MockServer,
    asyncStep,
    defineModels,
...
import { on, runAllTimers, waitUntil } from "@nwos/hoot-dom";
 ...
 *
 * @typedef {import("@web/env").NWOSEnv} NWOSEnv
...
/** @type {Record<string, (env: NWOSEnv, id: string, payload: any) => any>} */
const busMessageHandlers = {};
/** @type {Map<NWOSEnv, { id: number, type: string, payload: NotificationPayload }[]>} */
 ...
 *
 * @param {string} type
 * @param {(env: NWOSEnv, id: string, payload: any) => any} handler
 */
