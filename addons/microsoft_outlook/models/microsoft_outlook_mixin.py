...
from nwos.tools import hmac, email_normalize
from nwos.tools.urls import urljoin as url_join
from nwos.addons.google_gmail.tools import get_iap_error_message
...
class MicrosoftOutlookMixin(models.AbstractModel):
    ...
    _OUTLOOK_SCOPE = None
    _DEFAULT_OUTLOOK_IAP_ENDPOINT = 'https://outlook.api.nwos.com'
