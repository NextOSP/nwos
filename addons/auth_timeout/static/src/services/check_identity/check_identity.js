import { Component, EventBus, onWillDestroy, onWillStart, useState } from "@nwos/owl";
    ...
    start(env, { bus_service, dialog, presence }) {
        ...
        const checkIdentityErrorHandler = (env, error, originalError) => {
            if (originalError instanceof RPCError) {
                if (originalError.data.name === "nwos.addons.auth_timeout.models.ir_http.CheckIdentityException") {
                    run();
                    return true;
                }
            }
