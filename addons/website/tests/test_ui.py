...
from nwos.addons.html_editor.controllers.main import HTML_Editor
from nwos.addons.website.tests.common import HttpCaseWithWebsiteUser
from nwos.fields import Command


@nwos.tests.tagged('-at_install', 'post_install')
class TestUiCustomizeTheme(nwos.tests.HttpCase):
...
class TestUiHtmlEditor(HttpCaseWithUserDemo):
    ...
    def test_code_editor_usable(self):
        ...
        url = '/nwos/action-website.website_preview'
        self.start_tour(url, 'website_code_editor_usable', login='admin')


@nwos.tests.tagged('external', '-standard', '-at_install', 'post_install')
...
@nwos.tests.tagged('-at_install', 'post_install')
class TestUiTranslate(nwos.tests.HttpCase):
...
class TestUi(HttpCaseWithWebsiteUser):
    ...
    def test_01_admin_tour_homepage(self):
        self.start_tour("/nwos", 'homepage', login='admin')
    ...
    def test_10_website_conditional_visibility(self):
        ...
        self.start_tour('/nwos', 'conditional_visibility_2', login='website_user')
    ...
    def test_19_website_page_options(self):
        self.start_tour("/nwos", "website_page_options", login="admin")
    ...
    def test_21_website_start_cloned_snippet(self):
        self.start_tour('/nwos', 'website_start_cloned_snippet', login='admin')

    def test_22_website_gray_color_palette(self):
        self.start_tour('/nwos', 'website_gray_color_palette', login='admin')
    ...
    def test_26_website_media_dialog_icons(self):
        self.env.ref('website.default_website').write({
            'social_twitter': 'https://twitter.com/NWOS',
            'social_facebook': 'https://www.facebook.com/NWOS',
            'social_linkedin': 'https://www.linkedin.com/company/nwos',
            'social_youtube': 'https://www.youtube.com/user/NWOSonline',
            'social_github': 'https://github.com/nwos',
            'social_instagram': 'https://www.instagram.com/explore/tags/nwos/',
            'social_tiktok': 'https://www.tiktok.com/@nwos',
    ...
    def test_27_website_clicks(self):
        self.start_tour('/nwos', 'website_click_tour', login='admin')
    ...
    def test_33_website_menus(self):
        ...
        self.start_tour("/nwos/action-website.action_website_menu", "parent_child_menu", login="admin")
