NWOS Website Builder
--------------------

Get an awesome and <a href="https://www.nwos.com/app/website">free website</a>,
easily customizable with the NWOS <a href="https://www.nwos.com/app/website">website builder</a>.
...
Create beautiful websites with no technical knowledge. NWOS's unique *'edit
...
NWOS's building blocks allow to design modern websites that are not possible
...
core focus. With the NWOS integration, you benefit from the best management
...
your work easily as an NWOS module.
...
createdb nwos
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -i website
```
...
```bash
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -u website
```
