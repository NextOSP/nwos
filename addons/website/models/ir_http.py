...
import nwos
from nwos import api, models, tools
...
from nwos.addons.portal.controllers.portal import _build_url_w_params
...
def get_request_website():
    ...
    ```
    from nwos.addons.website.models import ir_http
...
class IrHttp(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(nwos.tools.config['server_wide_modules'])
