...
from nwos import api, fields, models, tools, release
from nwos.addons.website.models.ir_http import sitemap_qs2dom
from nwos.addons.website.tools import similarity_score, text_from_html, get_base_domain
from nwos.addons.portal.controllers.portal import pager
...
from nwos.tools import SQL, Query
from nwos.tools.image import image_process
from nwos.tools.sql import escape_psql
...
DEFAULT_WEBSITE_ENDPOINT = 'https://website.api.nwos.com'
DEFAULT_OLG_ENDPOINT = 'https://olg.api.nwos.com'
...
class Website(models.Model):
        ...
        for model_name, field_name in self._get_html_fields():
            ...
            if dependency_records:
                ...
                dependencies[model_display_name] += [{
                    ...
                    'link': 'website_url' in rec and rec.website_url or f'/nwos/{model_name}/{rec.id}',
    ...
    def get_website_page_ids(self):
        ...
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the NWOS framework works.
    ...
    def get_client_action_url(self, url, mode_edit=False, mode_debug=0):
        ...
        return "/nwos/action-website.website_preview?" + urls.url_encode(action_params)
