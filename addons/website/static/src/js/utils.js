...
import { App, Component } from "@nwos/owl";
...
export function sendRequest(route, params) {
    ...
    if (nwos.csrf_token) {
        _addInput(form, "csrf_token", nwos.csrf_token);
    }
...
patch(urlUtils, {
    isAbsoluteURLInCurrentDomain(url, env = null) {
        ...
        // Make sure that while being on abc.nwos.com, if you edit a link and
        // enter an absolute URL using your real domain, it is still considered
        // to be added as relative, preferably.
        // In the past, you could not edit your website from abc.nwos.com if you
