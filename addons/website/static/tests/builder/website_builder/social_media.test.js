import { expect, queryAll, test } from "@nwos/hoot";
import {
    defineWebsiteModels,
...
import { click, queryOne } from "@nwos/hoot-dom";
...
test("add social medias", async () => {
    onRpc("website", "read", ({ args }) => {
        ...
        return [{ id: 1, social_facebook: "https://fb.com/nwos", social_twitter: false }];
    });
...
test("reorder social medias", async () => {
    onRpc("website", "read", ({ args }) => [
        { id: 1, social_facebook: "https://fb.com/nwos", social_twitter: "https://x.com/nwos" },
    ]);
    ...
    expect("tr [data-action-param='facebook'] input").toHaveValue("https://fb.com/nwos");
    expect("tr [data-action-param='twitter'] input").toHaveValue("https://x.com/nwos");
    ...
    expect("tr:nth-child(1) input[type=text]").toHaveValue("https://x.com/nwos");
    ...
    expect("tr:nth-child(4) input[type=text]").toHaveValue("https://fb.com/nwos");
    ...
    expect("tr:nth-child(2) input[type=text]").toHaveValue("https://x.com/nwos");
    ...
    expect("tr:nth-child(1) input[type=text]").toHaveValue("https://fb.com/nwos");
    expect("tr:nth-child(1) input[type=checkbox]").not.toBeChecked();
    expect("tr:nth-child(2) input[type=text]").toHaveValue("https://www.example.com/first");
    expect("tr:nth-child(3) input[type=text]").toHaveValue("https://x.com/nwos");
    ...
    expect("tr:nth-child(2) input[type=text]").toHaveValue("https://x.com/nwos");
    expect("tr:nth-child(2) input[type=checkbox]").toBeChecked();
    expect("tr:nth-child(3) input[type=text]").toHaveValue("https://fb.com/nwos");
    expect("tr:nth-child(3) input[type=checkbox]").not.toBeChecked();
    expect("tr:nth-child(4) input[type=text]").toHaveValue("https://www.example.com");
    ...
    expect("tr:nth-child(2) input[type=text]").toHaveValue("https://fb.com/nwos");
    expect("tr:nth-child(2) input[type=checkbox]").not.toBeChecked();
    expect("tr:nth-child(3) input[type=text]").toHaveValue("https://www.example.com/first");
    expect("tr:nth-child(4) input[type=text]").toHaveValue("https://www.example.com");
...
test("save social medias", async () => {
    ...
    await contains("div[data-action-param='facebook'] input").edit("https://facebook.com/NWOS");

    let writeCalled = false;
    onRpc("website", "write", ({ args }) => {
        expect(args[0]).toEqual([1]);
        expect(args[1]).toInclude(["social_facebook", "https://facebook.com/NWOS"]);
        expect(args[1]).toInclude(["social_twitter", "https://x.com/nwos"]);
        writeCalled = true;
        return true;
    });
