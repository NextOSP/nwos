...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        ...addNewSocialNetwork(10, 9, "https://instagr.am/nwos.official/"),
        {
            ...
            trigger:
                ...
                ":has(a:eq(9)[href='https://instagr.am/nwos.official/']:has(i.fa-instagram))",
        },
        ...
        },
        {
            ...
            run: "edit https://instagram.com/nwos.official/ && click body",
        },
        ...preventRaceConditionStep,
        ...clickOnSave(),
        ...clickOnEditAndWaitEditMode(),
