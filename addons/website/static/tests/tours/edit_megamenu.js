...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        toggleMegaMenu({}),
        {
            ...
            trigger: ":iframe .s_mega_menu_nwos_menu .row > div:first-child .nav > :nth-child(6)", // 6th is the last one
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                ":iframe .s_mega_menu_nwos_menu .row > div:first-child .nav:not(:has(:nth-child(6)))",
        },
        {
...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        clickOnExtraMenuItem({}, true),
        toggleMegaMenu({}),
        ...openLinkPopup(":iframe .s_mega_menu_nwos_menu .nav-link:contains('Laptops')", "Laptops"),
        {
        ...
        toggleMegaMenu(),
        {
            ...
            trigger: ":iframe .s_mega_menu_nwos_menu .row > div:first-child .nav > :nth-child(1)",
            run: "click",
        },
        {
...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        toggleMegaMenu({}),
        {
            ...
            trigger: ":iframe .s_mega_menu_nwos_menu .row > div:first-child .nav > :first-child",
            run: "click",
        },
