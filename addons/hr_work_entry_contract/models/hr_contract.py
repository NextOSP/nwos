...
def string_to_datetime(value):
    """ Convert the given string/datetime value to a UTC-aware datetime. """
    return pytz.utc.localize(fields.Datetime.to_datetime(value))

from nwos.osv import expression
from nwos.tools import ormcache
