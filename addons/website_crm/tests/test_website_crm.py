...
class TestWebsiteCrm(nwos.tests.HttpCase, TestCrmCommon):
    ...
    def test_tour(self):
        ...
        self.assertEqual(record.partner_name, 'NWOS')
    ...
    def test_catch_logged_partner_info_tour(self):
        ...
        with nwos.tests.RecordCapturer(self.env['crm.lead']) as capt:
