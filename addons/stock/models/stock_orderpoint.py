...
from nwos import SUPERUSER_ID, _, api, fields, models
from nwos.addons.stock.models.stock_rule import ProcurementException
...
from nwos.tools import float_compare, float_is_zero, frozendict, split_every, format_date
            ...
            return {
                ...
                'params': {
                    ...
                    'links': [{
                        ...
                        'url': f'/nwos/action-stock.stock_picking_action_picking_type/{move.picking_id.id}'
                    }],
                    'sticky': False,
