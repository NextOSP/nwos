...
import { Component, onWillStart, useEffect, useRef } from "@nwos/owl";
...
export class ReplenishmentGraphWidget extends JsonPopOver {
    ...
    getScatterGraphConfig() {
        ...
        const maxLineColor = getColor(1, cookie.get("color_scheme"), "nwos");
        const minLineColor = getColor(2, cookie.get("color_scheme"), "nwos");
        const curveLineColor = getColor(3, cookie.get("color_scheme"), "nwos");
        return {
            type: "scatter",
            data: {
                labels,
