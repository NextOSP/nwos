...
from nwos.addons.stock.tests.common import TestStockCommon
from nwos.exceptions import ValidationError
from nwos.tests import Form, HttpCase, tagged
from nwos.tests.common import users
from nwos.tools import mute_logger, float_round
...
class TestStockFlowTourPostInstall(TestStockCommon, HttpCase):
    ...
    def test_basic_stock_flow_with_minimal_access_rights(self):
        ...
        self.start_tour('/nwos', 'test_basic_stock_flow_with_minimal_access_rights', login='pauline')
