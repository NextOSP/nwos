...
from nwos.addons.base.models.res_partner import _tz_get
from nwos.addons.calendar.models.calendar_attendee import CalendarAttendee
from nwos.addons.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from nwos.addons.calendar.models.utils import interval_from_events
from nwos.tools.intervals import intervals_overlap
from nwos.tools.translate import _
from nwos.tools.misc import get_lang
from nwos.tools import html2plaintext, html_sanitize, is_html_empty, single_email_re
...
class CalendarEvent(models.Model):
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'NWOS'
    ...
    def _get_contact_details_description(self, organizer, partners):
        ...
        """
        nwosbot = self.env.ref('base.user_root')
        contact_description = []
        # Organizer
        if organizer and organizer != nwosbot:
        ...
        contact_partners = partners.filtered(lambda partner: partner not in (nwosbot.partner_id + organizer.partner_id))
