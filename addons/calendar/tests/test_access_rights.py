...
from nwos.tests.common import TransactionCase, new_test_user
...
class TestAccessRights(TransactionCase):
    ...
    @classmethod
    @mute_logger('nwos.tests', 'nwos.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_meeting_edit_access_notification_handle_in_nwos(self):
        # set notifications to "handle in NWOS" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in NWOS" notification setting can
