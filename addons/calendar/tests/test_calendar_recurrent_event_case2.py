...
from nwos.addons.calendar.models.calendar_recurrence import MAX_RECURRENT_EVENT
...
class TestRecurrentEvent(common.TransactionCase):
    ...
    def test_recurrent_meeting1(self):
        # In order to test recurrent meetings in NWOS, I create meetings with different recurrence using different test cases.
