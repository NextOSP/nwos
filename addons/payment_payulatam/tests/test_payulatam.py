...
from nwos.addons.payment_payulatam.controllers.main import PayuLatamController
from nwos.addons.payment_payulatam.tests.common import PayULatamCommon
...
class PayULatamTest(PayULatamCommon, PaymentHttpCommon):
    ...
    @mute_logger('nwos.addons.payment_payulatam.controllers.main')
    ...
    def test_webhook_notification_triggers_signature_check(self):
        ...
        url = self._build_url(PayuLatamController._webhook_url)
        with patch(
            'nwos.addons.payment_payulatam.controllers.main.PayuLatamController'
