...
from nwos.addons.website.controllers import form
...
class WebsiteForm(form.WebsiteForm):
    def insert_record(self, request, model_sudo, values, custom, meta=None):
        ...
        if model_name == 'project.task':
            ...
            # When a task is created from the web editor, if the key 'user_ids' is not present, the user_ids is filled with the nwos bot. We set it to False to ensure it is not.
