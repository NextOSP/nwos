...
class TestAuthLDAP(HttpCase):
    ...
    def test_auth_ldap(self):
            ...
            return [
                {
                    ...
                    "ldap_binddn": "cn=admin,dc=nwos,dc=com",
                    "ldap_password": "admin",
                    "ldap_filter": "cn=%s",
                    "ldap_base": "dc=nwos,dc=com",
                    "user": (6, "Marc Demo"),
                    "create_user": True,
                    "ldap_tls": False,
                }
        ...
        def _authenticate(*args, **kwargs):
            return (
                "cn=test_ldap_user,dc=nwos,dc=com",
                {
                    "sn": [b"test_ldap_user"],
                    "cn": [b"test_ldap_user"],
        ...
        session = nwos.http.root.session_store.get(res.cookies["session_id"])
        self.assertEqual(
