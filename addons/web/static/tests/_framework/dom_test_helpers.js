...
/**
 * @typedef {import("@nwos/hoot").DragHelpers} DragHelpers
 * @typedef {import("@nwos/hoot").DragOptions} DragOptions
 * @typedef {import("@nwos/hoot").FillOptions} FillOptions
 * @typedef {import("@nwos/hoot").InputValue} InputValue
 * @typedef {import("@nwos/hoot").KeyStrokes} KeyStrokes
 * @typedef {import("@nwos/hoot").PointerOptions} PointerOptions
 * @typedef {import("@nwos/hoot").Position} Position
 * @typedef {import("@nwos/hoot").QueryOptions} QueryOptions
 * @typedef {import("@nwos/hoot").Target} Target
 *
 * @typedef {DragOptions & {
