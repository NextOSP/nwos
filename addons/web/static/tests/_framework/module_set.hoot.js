...
class ModuleSetLoader extends loader.constructor {
    ...
    constructor(moduleSet) {
        ...
        nwos.define = this.define.bind(this);
        nwos.loader = this;
    }
...
const AUTO_INCLUDED_ADDONS = {
    /**
     * spreadsheet addons defines a module that does not starts with `@spreadsheet` but `@nwos` (`@nwos/o-spreadsheet)
     * To ensure that this module is loaded, we have to include `nwos` in the dependencies
     */
    spreadsheet: ["nwos"],
    /**
...
const CSRF_TOKEN = nwos.csrf_token;
...
const R_DEFAULT_MODULE = /^@nwos\/(owl|hoot)/;
