import { after, afterEach, beforeEach, registerDebugInfo } from "@nwos/hoot";
 ...
 *
 * @param {Partial<NWOSEnv>} [partialEnv]
 * @param {{
 *  makeNew?: boolean;
 * }} [options]
 */
 ...
 *  (env: NWOSEnv, dependencies: Dependencies) => Services[T]
 * } serviceFactory
 */
