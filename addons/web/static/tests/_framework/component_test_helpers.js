import { after, destroy, getFixture, queryFirst, queryOne } from "@nwos/hoot";
import { App, Component, xml } from "@nwos/owl";
 ...
 * @typedef {import("@nwos/owl").Component} Component
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@nwos/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
 ...
 * @param {AppConfig & {
 *  componentEnv?: Partial<NWOSEnv>;
 *  containerEnv?: Partial<NWOSEnv>;
