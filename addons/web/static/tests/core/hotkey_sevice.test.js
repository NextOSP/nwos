import { destroy, expect, getFixture, onError, test } from "@nwos/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@nwos/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@nwos/hoot-mock";
import { Component, useRef, useState, xml } from "@nwos/owl";
import {
    contains,
    getService,
    makeMockEnv,
