/** @nwos-module alias=@web/../tests/mobile/core/action_swiper_tests default=false */

import { beforeEach, expect, test } from "@nwos/hoot";
import { hover, queryFirst } from "@nwos/hoot-dom";
import { advanceTime, animationFrame, mockTouch } from "@nwos/hoot-mock";
import { Component, onPatched, xml } from "@nwos/owl";
import {
    contains,
    defineParams,
    mountWithCleanup,
