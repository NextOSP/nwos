import { destroy, expect, mockTouch, test } from "@nwos/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@nwos/hoot-dom";
import { animationFrame } from "@nwos/hoot-mock";
import { Component, onMounted, useState, xml } from "@nwos/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
