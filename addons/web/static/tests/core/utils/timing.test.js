import { describe, destroy, expect, getFixture, test } from "@nwos/hoot";
import { click, tick } from "@nwos/hoot-dom";
import { Deferred, advanceTime, animationFrame, microTick, runAllTimers } from "@nwos/hoot-mock";
