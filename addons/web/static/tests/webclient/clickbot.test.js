...
import { animationFrame, Deferred, mockDate, runAllTimers, tick } from "@nwos/hoot-mock";
import {
    defineActions,
    defineMenus,
    defineModels,
...
import { onWillStart, onWillUpdateProps } from "@nwos/owl";
...
test("clickbot show rpc error when an error dialog is detected", async () => {
    ...
    const expectedRpcData = JSON.stringify({
        ...
        error: {
            ...
            code: 0,
            data: {
                name: "nwos.exceptions.Programming error",
                debug: "traceback",
                arguments: [],
                context: {},
                message: "This is a server Error, it should be displayed in an error dialog",
            },
            exceptionName: "nwos.exceptions.Programming error",
            subType: "server",
            message: "This is a server Error, it should be displayed in an error dialog",
            model: "foo",
