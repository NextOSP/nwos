import { getFixture, after } from "@nwos/hoot";
...
export async function startInteractions(
    ...
    if (nwos.loader.modules.has("@mail/../tests/mail_test_helpers")) {
        const { defineMailModels } = nwos.loader.modules.get("@mail/../tests/mail_test_helpers");
        defineMailModels();
    }
