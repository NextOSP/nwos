...
import { Deferred, animationFrame, runAllTimers } from "@nwos/hoot-mock";
...
test("many2one in non edit mode (with value)", async () => {
    ...
    expect("div[name=res_trululu] a.o_form_uri").toHaveAttribute("href", "/nwos/res.partner/1");
    expect("div[name=trululu] a.o_form_uri").toHaveAttribute("href", "/nwos/m-partner/4");
});
