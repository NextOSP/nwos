...
import { mockDate, mockTimeZone } from "@nwos/hoot-mock";
import { Component, onRendered, onWillStart, xml } from "@nwos/owl";
import {
    MockServer,
    contains,
    defineActions,
...
/**
 * @param {import("@nwos/hoot-dom").Target} from
 * @param {import("@nwos/hoot-dom").Target} to
 * @param {{
