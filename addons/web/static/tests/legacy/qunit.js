/** @nwos-module alias=@web/../tests/qunit default=false */
...
export function setupQUnit() {
    ...
    QUnit.done(async (result) => {
        await nwos.loader.checkErrorProm;
    ...
    QUnit.begin(function () {
        if (nwos.debug && nwos.debug.includes("assets")) {
    ...
    QUnit.on("NWOSAfterTestHook", (info) => {
