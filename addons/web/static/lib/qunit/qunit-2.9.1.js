...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("NWOSBeforeTestHook", "NWOSAfterTestHook"); // NWOS customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("NWOSBeforeTestHook"); // NWOS customization
