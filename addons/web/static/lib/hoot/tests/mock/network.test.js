...
import { after, describe, expect, mockFetch, test } from "@nwos/hoot";
...
describe(parseUrl(import.meta.url), () => {
    ...
    test("fetch with internal URLs should return default value", async () => {
        ...
        const internal = await fetch("/nwos").then((res) => res.text());
        ...
        expect.verifySteps(["http://some.url", "/nwos", "data:text/html,<body></body>"]);
    });
