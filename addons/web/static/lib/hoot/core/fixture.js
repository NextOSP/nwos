...
import { animationFrame } from "@nwos/hoot-dom";
import { App } from "@nwos/owl";
...
/**
 * @typedef {Parameters<typeof import("@nwos/owl").mount>[2] & {
 *  className: string | string[];
 *  target?: import("@nwos/hoot-dom").Target;
 * }} MountOnFixtureOptions
 *
 * @typedef {{
 *  component: import("@nwos/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
/**
 * @param {App | import("@nwos/owl").Component} target
 */
