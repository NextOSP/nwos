 ...
 *
 * @typedef {import("@nwos/hoot-dom").Dimensions} Dimensions
 * @typedef {import("@nwos/hoot-dom").FormatXmlOptions} FormatXmlOptions
 ...
 * @typedef {import("@nwos/hoot-dom").QueryRectOptions} QueryRectOptions
 * @typedef {import("@nwos/hoot-dom").QueryTextOptions} QueryTextOptions
 * @typedef {import("@nwos/hoot-dom").Target} Target
 */
...
export class Matcher {
     ...
     * @example
     *  expect("header h1").toHaveText(/nwos/i);
     */
