...
This vendored library is loaded through NWOS asset bundles. To work on the
surrounding application, set up the main server from the repository root:
...
Do not update vendored files in place unless you are intentionally upgrading the
library and have checked the dependent asset bundles.
