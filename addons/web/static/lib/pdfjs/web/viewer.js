...
class BasePreferences {
  #defaults = Object.freeze({
    ...
    // NWOS: don't support scripting (#115302)
    enableScripting: false,
    enableUpdatedAddImage: false,
    // NWOS: open links in new tabs to keep nwos document (#84594)
...
class PDFPrintService {
  ...
  layout() {
    ...
    // NWOS PATCH PRINT PREVIEW MOBILE
