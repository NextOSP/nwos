 ...
 */
export function nwosmark(text) {
    /**
     * Mapping of patterns - replacer functions to apply to nwosmarked strings.
     *
     ...
     *
     * Note: this list is declared inline in the `nwosmark` function to avoid other
