...
import { Component, useRef, useSubEnv } from "@nwos/owl";
 ...
 * It uses a feature to automatically create links to other nwos pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
