...
import { Component, onMounted, onWillStart, useExternalListener, useState } from "@nwos/owl";
...
export class WebClient extends Component {
    ...
    _loadDefaultApp() {
        return this.actionService.doAction("apps_menu", { clearBreadcrumbs: true });
    }
    ...
    registerServiceWorker() {
        if (navigator.serviceWorker) {
            navigator.serviceWorker
                .register("/web/service-worker.js", { scope: "/nwos" })
                .then((registration) => {
