...
import { App, reactive } from "@nwos/owl";
...
function setup(light, currentState) {
    env = nwos.__WOWL_DEBUG__.root.env;
    ...
    isEnterprise = nwos.info && nwos.info.isEnterprise;
...
async function _clickEverywhere(xmlId, light, currentState) {
    ...
    console.log(`NWOS flavor: ${isEnterprise ? "Enterprise" : "Community"}`);
