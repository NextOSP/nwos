...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(nwos.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in nwosToBootstrapClasses) {
                    cls = nwosToBootstrapClasses[cls];
                }
                classNames.push(cls);
