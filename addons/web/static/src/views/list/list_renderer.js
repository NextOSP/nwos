...
import { getCompanyCurrencyId, getCurrencyRates } from "@web/core/currency";
...
/** @extends Component<ListRendererProps, NWOSEnv> */
                ...
                if (currencyField in this.props.list.activeFields) {
                    ...
                    if (func && type === "monetary") {
                        ...
                        if (currencies.size > 1) {
                            multiCurrency = true;
                            currencyId = getCompanyCurrencyId();
    ...
    formatGroupAggregate(group, column) {
        ...
        if (field.type === "monetary") {
            ...
            if (currencies.length > 1 && aggregateValue !== false) {
                formatOptions.currencyId = getCompanyCurrencyId();
                return {
