...
import { getCompanyCurrencyId } from "@web/core/currency";
import { formatInteger, formatMonetary } from "@web/views/fields/formatters";

import { Component, onWillUnmount, onWillUpdateProps, useState } from "@nwos/owl";
...
export class AnimatedNumber extends Component {
    ...
    get currencyId() {
        ...
        if (currencies?.length) {
            return currencies.length > 1 ? getCompanyCurrencyId() : currencies[0];
        }
        return false;
    }
}
