import { Component, onWillStart, useExternalListener, useState } from "@nwos/owl";
import { getCompanyCurrencyId, getCurrency, getCurrencyRates } from "@web/core/currency";
...
export class MultiCurrencyPopover extends Component {
    ...
    setup() {
        ...
        this.defaultCurrency = getCompanyCurrencyId();
