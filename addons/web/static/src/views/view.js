...
function hasViewInfo() {
    return session.view_info && Object.keys(session.view_info).length > 0;
}

viewRegistry.addValidation({
    type: { validate: (t) => !hasViewInfo() || t in session.view_info },
...
/** @extends {Component<ViewProps, import("@web/env").NWOSEnv>} */
