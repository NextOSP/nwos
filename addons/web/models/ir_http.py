...
from nwos.http import request, DEFAULT_MAX_CONTENT_LENGTH
from nwos.tools import config
from nwos.tools.misc import hmac, str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = nwos.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.nwos.com/buy",
            "name": user.name,
            "username": user.login,
