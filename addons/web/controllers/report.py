...
from nwos.tools.misc import html_escape
...
class ReportController(http.Controller):
    ...
    # Authenticated read/download endpoint: allow stale webclient CSRF tokens
    # after server or asset reloads to avoid blocking report printing.
