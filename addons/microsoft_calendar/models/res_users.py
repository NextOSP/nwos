...
import logging
import requests
from nwos.addons.microsoft_calendar.models.microsoft_sync import microsoft_calendar_token
from datetime import datetime, timedelta

from nwos import api, fields, models, _, Command
from nwos.exceptions import UserError
from nwos.loglevels import exception_to_unicode
from nwos.addons.microsoft_account.models import microsoft_service
from nwos.addons.microsoft_calendar.utils.microsoft_calendar import InvalidSyncToken
...
class ResUsers(models.Model):
    ...
    def _sync_microsoft_calendar(self):
        ...
        # Microsoft -> NWOS
        synced_events, synced_recurrences = self.env['calendar.event']._sync_microsoft2nwos(events) if events else (self.env['calendar.event'], self.env['calendar.recurrence'])

        # NWOS -> Microsoft
        recurrences = self.env['calendar.recurrence']._get_microsoft_records_to_sync(full_sync=full_sync)
        recurrences -= synced_recurrences
        recurrences._sync_nwos2microsoft()
        ...
        (events - synced_events)._sync_nwos2microsoft()
    ...
    def _set_ICP_first_synchronization_date(self, now):
        ...
        created NWOS events and thus avoid spamming invitations for those events.
        """
