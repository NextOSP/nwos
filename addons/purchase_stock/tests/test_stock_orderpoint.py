...
class TestStockWarehouseOrderpoint(HttpCase):
    ...
    def test_product_replenishment(self):
        ...
        self.start_tour("/nwos/replenishment", "test_product_replenishment", login='admin')
    ...
    def test_replenishment_supplier_multicompany_access(self):
        ...
        self.start_tour('/nwos/replenishment', 'test_replenishment_supplier_multicompany_access', login='admin')
