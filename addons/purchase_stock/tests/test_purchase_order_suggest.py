...
from nwos.addons.purchase_stock.tests.common import PurchaseTestCommon
from nwos.tests import tagged, freeze_time
...
class TestPurchaseOrderSuggest(PurchaseTestCommon, HttpCase):
    ...
    def test_purchase_order_suggest_search_panel_ux(self):
        ...
        self.start_tour('/nwos/purchase', "test_purchase_order_suggest_search_panel_ux", login='admin')
