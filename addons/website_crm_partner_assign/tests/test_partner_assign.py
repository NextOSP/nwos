...
from nwos.tests.common import tagged, new_test_user, JsonRpcException, TransactionCase
from nwos.tools import mute_logger

from nwos.addons.base.tests.common import HttpCase
from nwos.addons.crm.tests.common import TestCrmCommon
from nwos.addons.mail.controllers.thread import ThreadController
from nwos.addons.mail.tests.common import mail_new_test_user
from nwos.addons.http_routing.tests.common import MockRequest
from nwos.addons.website_crm_partner_assign.controllers.main import (
    WebsiteAccount,
...
class TestPartnerAssign(TransactionCase):
    ...
    def setUp(self):
        ...
        patcher = patch('nwos.addons.base_geolocalize.models.base_geocoder.BaseGeocoder.geo_find', wraps=geo_find)
...
class TestPartnerLeadPortal(TestCrmCommon, HttpCase):
    ...
    def test_portal_post_child_contact_assigned(self):
        ...
        with self.assertRaises(JsonRpcException), mute_logger('nwos.http'):
            self.make_jsonrpc_request(
                route="/mail/message/post",
                params={
                    'thread_model': self.lead_portal._name,
    ...
    @patch('nwos.http.GeoIP')
    def test_03_crm_partner_assign_geolocalization(self, GeoIpMock):
        """
            This test checks situation when "{NWOSURL}/partners" is visited from foreign country without resellers.
        ...
        """
        # Patch GeoIp so it acts, as if NWOS client is located in Mexico
