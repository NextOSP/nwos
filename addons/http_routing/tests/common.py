...
import nwos.http
from nwos.tests import HOST, HttpCase
from nwos.tools import DotDict, config, frozendict
...
def MockRequest(
    ...
    request = Mock(
        ...
        type='http',
        future_response=nwos.http.FutureResponse(),
        params={},
        ...
        geoip=nwos.http.GeoIP('127.0.0.1'),
    ...
    if country_code or city_name:
        try:
            request.geoip._city_record = nwos.http.geoip2.models.City(['en'], country=(country_code and {'iso_code': country_code}) or {}, city=(city_name and {'names': {'en': city_name}}) or {})
        except TypeError:
            request.geoip._city_record = nwos.http.geoip2.models.City({'country': (country_code and {'iso_code': country_code}) or {}, 'city': (city_name and {'names': {'en': city_name}}) or {}})
    ...
    #
    #   router = nwos.http.root.get_db_router()
    ...
    with contextlib.ExitStack() as s:
        ...
        s.callback(nwos.http._request_stack.pop)
        s.enter_context(patch('nwos.http.root.get_db_router', router))
