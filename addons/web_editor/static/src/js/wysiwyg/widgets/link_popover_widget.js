...
export class LinkPopoverWidget {
    static createFor(params) {
        ...
        params.wysiwyg?.nwosEditor.observerUnactive('LinkPopoverWidget');
        popoverWidget.start(); // This is not async
        params.wysiwyg?.nwosEditor.observerActive('LinkPopoverWidget');
    ...
    start() {
        ...
        if (document !== this.wysiwyg.nwosEditor.document) {
            $(this.wysiwyg.nwosEditor.document).on('mouseup.link_popover', onClickDocument);
        }
    ...
    destroy() {
        ...
        $(this.wysiwyg.nwosEditor.document).off('.link_popover');
