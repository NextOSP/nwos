...
import { deduceURLfromText } from "@web_editor/js/editor/nwos-editor/src/utils/sanitize";

const { getDeepRange, getInSelection, EMAIL_REGEX, PHONE_REGEX } = NWOSEditorLib;
...
export class Link extends Component {
    ...
    async _updateState(props) {
        ...
        if (this.state.range) {
            this.$link = this.$link || $(NWOSEditorLib.getInSelection(this.editable.ownerDocument, 'a'));
