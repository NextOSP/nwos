...
export class NWOSEditor extends EventTarget {
    constructor(editable, options = {}) {
        ...
        this.options = defaultOptions(
            {
                ...
                // `convertNumericToUnit` as nwos-editor utils to avoid this
        ...
        this.editable.classList.add("nwos-editor-editable");
    ...
    _onClipboardCopy(clipboardEvent) {
        ...
        const nwosHtml = dataHtmlElement.innerHTML.replace(/\uFEFF/g, "");
        const nwosText = selection.toString().replace(/\uFEFF/g, "").replace(/\u00A0/g, " ");
        clipboardEvent.clipboardData.setData('text/plain', nwosText);
        clipboardEvent.clipboardData.setData('text/html', nwosHtml);
        clipboardEvent.clipboardData.setData('text/nwos-editor', nwosHtml);
    }
    /**
     * @private
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('nwos-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const nwosEditorHtml = ev.clipboardData.getData('text/nwos-editor');
        ...
        } else if (nwosEditorHtml) {
            const fragment = parseHTML(this.document, nwosEditorHtml);
