...
import { NWOSEditor } from '../src/NWOSEditor.js';
...
export async function testEditor(Editor = NWOSEditor, spec, options = {}) {
    hasMobileTest = false;
...
export const pasteNWOSEditorHtml = async (editor, html) => pasteData(editor, html, 'text/nwos-editor');
...
export class BasicEditor extends NWOSEditor {}
