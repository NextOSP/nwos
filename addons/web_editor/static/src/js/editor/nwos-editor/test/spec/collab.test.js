...
import { NWOSEditor, parseHTML, setSelection, insertCharsAt } from '../../src/NWOSEditor.js';
import {
...
const testMultiEditor = async spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        NWOSEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new NWOSEditor(clientInfo.editable, Object.assign({
            toSanitize: false,
    ...
    NWOSEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
