...
from nwos import http, tools, _, SUPERUSER_ID, release
from nwos.addons.web_editor.tools import get_video_url_data
from nwos.exceptions import UserError, MissingError, AccessError
from nwos.tools.misc import file_open
from nwos.tools.mimetypes import guess_mimetype
from nwos.tools.image import image_data_uri, binary_to_image, get_webp_size
from nwos.addons.iap.tools import iap_tools
from nwos.addons.base.models.assetsbundle import AssetsBundle

from ..models.ir_attachment import SUPPORTED_IMAGE_MIMETYPES

logger = logging.getLogger(__name__)
DEFAULT_LIBRARY_ENDPOINT = 'https://media-api.nwos.com'
...
class Web_Editor(http.Controller):
    ...
    def shape(self, module, filename, **kwargs):
        ...
        if module == 'illustration':
            attachment = request.env['ir.attachment'].sudo().browse(request.env['ir.http']._unslug(filename)[1])
