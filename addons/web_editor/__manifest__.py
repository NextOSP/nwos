...
""",
    ...
    'assets': {
        ...
        'web_editor.wysiwyg_iframe_editor_assets': [
            ...
            'web/static/lib/owl/nwos_module.js',
            ...
            # nwos-editor
            'web_editor/static/src/js/editor/nwos-editor/src/utils/utils.js',
            'web_editor/static/src/js/editor/nwos-editor/src/utils/constants.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/align.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/commands.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/deleteBackward.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/deleteForward.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/enter.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/shiftEnter.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/shiftTab.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/tab.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/toggleList.js',

            # nwos utils
            'web_editor/static/src/scss/bootstrap_overridden.scss',
            'web/static/src/scss/pre_variables.scss',
            'web/static/lib/bootstrap/scss/_variables.scss',
            'web_editor/static/src/js/editor/nwos-editor/src/style.scss',
        ...
        'web_editor.assets_tests_styles': [
            ('include', 'web._assets_helpers'),
            'web_editor/static/src/js/editor/nwos-editor/src/base_style.scss',
            'web_editor/static/src/js/editor/nwos-editor/src/checklist.scss',
        ],
        'web_editor.assets_wysiwyg': [
            ...
            # nwos-editor
            'web_editor/static/src/js/editor/nwos-editor/src/NWOSEditor.js',
            'web_editor/static/src/js/editor/nwos-editor/src/utils/constants.js',
            'web_editor/static/src/js/editor/nwos-editor/src/utils/sanitize.js',
            'web_editor/static/src/js/editor/nwos-editor/src/utils/serialize.js',
            'web_editor/static/src/js/editor/nwos-editor/src/tablepicker/TablePicker.js',
            'web_editor/static/src/js/editor/nwos-editor/src/powerbox/patienceDiff.js',
            'web_editor/static/src/js/editor/nwos-editor/src/powerbox/Powerbox.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/align.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/commands.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/deleteBackward.js',
            'web_editor/static/src/js/editor/nwos-editor/src/commands/deleteForward.js',
        ...
        "web.assets_web_dark": [
            'web_editor/static/src/scss/nwos-editor/powerbox.dark.scss',
            'web_editor/static/src/scss/nwos-editor/tablepicker.dark.scss',
            'web_editor/static/src/scss/nwos-editor/tableui.dark.scss',
        ...
        'web.qunit_suite_tests': [
            ...
            'web_editor/static/src/js/editor/nwos-editor/test/utils.js'
        ],
        'web_editor.mocha_tests': [
            ...
            'web_editor/static/src/js/editor/nwos-editor/src/**/*js',
            'web_editor/static/src/js/editor/nwos-editor/test/spec/*js',
            'web_editor/static/src/js/editor/nwos-editor/test/*js',
        ],
    },
    # NWOS 19 removed web_editor in favour of html_editor/html_builder.
    # Keep the module on disk for the ~92 NWOS-only modules that still
    # reference it, but do NOT auto-install it (it duplicates html_editor's
    # services and conflicts). Proper migration: repoint dependents to
    # html_editor, then drop this module.
    'auto_install': False,
    'installable': False,
    'license': 'LGPL-3',
}
