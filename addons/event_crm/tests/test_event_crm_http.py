from nwos.addons.event_crm.tests.common import TestEventCrmCommon
...
class TestEventCrmHttp(TestEventCrmCommon, HttpCase):
    ...
    def test_event_question_answers_lead_creation(self):
        ...
        self.start_tour("/nwos", "event_question_answers_rule_creation_tour", login="admin")
        ...
        self.env["event.registration"].create({
            ...
            "email": "event_question_answer_email@nwos.com",
        ...
        self.assertEqual(
            len(self.env["crm.lead"].search([("email_normalized", "=", "event_question_answer_email@nwos.com")])),
            1
        )
