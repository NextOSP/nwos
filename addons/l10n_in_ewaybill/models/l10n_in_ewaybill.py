...
from nwos.addons.l10n_in_ewaybill.tools.ewaybill_api import EWayBillApi, EWayBillError
...
class L10nInEwaybill(models.Model):
    ...
    def _handle_internal_warning_if_present(self, response):
        if warnings := response.pop('nwos_warning', False):
    ...
    def _set_data_from_attachment(self):
        ...
        see https://github.com/nwos/upgrade/pull/6624 for futher information
        """
        self.ensure_one()
