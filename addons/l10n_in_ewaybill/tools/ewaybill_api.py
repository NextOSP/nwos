...
from nwos.addons.l10n_in_ewaybill.models.error_codes import ERROR_CODES
from nwos.tools import _, LazyTranslate
...
class EWayBillError(Exception):
    ...
    def __init__(self, response):
        ...
        self.error_json.setdefault('nwos_warning', [])
    ...
    def _ewaybill_make_transaction(self, operation_type, json_payload):
        ...
        try:
            ...
            if "no-credit" in e.error_codes:
                e.error_json['nwos_warning'].append({
            ...
            if '238' in e.error_codes:
                ...
                # This happens when authenticate called from another nwos instance with same credentials
                # (like. Demo/Test)
