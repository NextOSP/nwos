...
from nwos.tools import float_compare, float_round
from nwos.addons.l10n_jo_edi.tests.jo_edi_common import JoEdiCommon
from nwos.addons.l10n_jo_edi.models.account_edi_xml_ubl_21_jo import JO_MAX_DP
...
class TestJoEdiPrecision(JoEdiCommon):
    ...
    def _validate_jo_edi_numbers(self, xml_string, amount_total):
        ...
        Moreover, reported totals have to equal (or at least be as close as possible) to totals stored in NWOS.
        And since the JOD has precision of 3 decimal places, everything is stored in NWOS approximated to 3 decimal places.
        -------------------------------------------------------------------------------
