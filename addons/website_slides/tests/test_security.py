...
from nwos.addons.base.tests.test_mimetypes import PNG
from nwos.addons.mail.tests.common import mail_new_test_user
from nwos.addons.website_slides.tests import common
from nwos.exceptions import AccessError
from nwos.tests import tagged, HttpCase
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('nwos.models', 'nwos.addons.base.models.ir_rule')
...
class TestAccessHttp(common.SlidesCase, HttpCase):
    @mute_logger('nwos.models', 'nwos.addons.base.models.ir_rule', 'nwos.http')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('nwos.models.unlink', 'nwos.addons.base.models.ir_rule', 'nwos.addons.base.models.ir_model')
...
class TestReview(common.SlidesCase, HttpCase):
    ...
    def test_channel_multiple_reviews(self):
        ...
        self.assertIn("nwos.exceptions.ValidationError", res2.text)
