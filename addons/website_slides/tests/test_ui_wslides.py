...
from nwos import http, tests
from nwos.addons.base.tests.common import HttpCaseWithUserPortal
from nwos.addons.gamification.tests.common import HttpCaseGamification
from nwos.addons.mail.models.mail_message import MailMessage
from nwos.fields import Command, Datetime
...
class TestUi(TestUICommon):
    ...
    @mute_logger("nwos.http", "nwos.addons.base.models.ir_rule", "werkzeug")
    ...
    def test_review_link_redirection(self):
        ...
        cases = [
            ("admin", rf"^/nwos/slide.channel/.*highlight_message_id={message.id}"),
...
class TestUiPublisher(HttpCaseGamification):
    ...
    def fetch_proxy(self, url):
        if url.endswith('ThreeTimeAKCGoldWinnerPembrookeWelshCorgi.jpg'):
            ...
            with file_open('base/tests/nwos.jpg', 'rb') as f:
                content = f.read()
