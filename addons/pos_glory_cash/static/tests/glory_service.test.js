import { beforeEach, describe, expect, test, waitUntil } from "@nwos/hoot";
...
const expectedDateTimeMessage =
    '<AdjustTimeRequest><Id>NWOSPos</Id><SeqNo>00000000000</SeqNo><Date year="2019" month="3" day="11"/><Time hour="10" minute="30" second="0"/></AdjustTimeRequest>\0';
const expectedGetStatusMessage =
    '<StatusRequest><Id>NWOSPos</Id><SeqNo>00000000000</SeqNo><RequireVerification type="1"/></StatusRequest>\0';
const expectedGetInventoryMessage =
    '<InventoryRequest><Id>NWOSPos</Id><SeqNo>00000000000</SeqNo><Option type="2"/></InventoryRequest>\0';
