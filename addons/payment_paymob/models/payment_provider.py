...
from nwos.addons.payment_paymob import const
...
class PaymentProvider(models.Model):
    ...
    def _match_paymob_payment_methods(self, paymob_gateways_data):
        """ Filter gateways available in Paymob to match the payment methods enabled in NWOS.

        This method takes the full list of gateways from Paymob, and while avoiding duplicates,
        returns only those that:

        1. Have a gateway_type mapped to an NWOS payment method code.
    ...
    def _update_payment_method_integration_names(self, matched_gateways_data):
        ...
        :param list matched_gateways_data: The gateways data matching payment methods in NWOS.
        :return: None
        """
