...
from nwos import _, Command
from nwos.exceptions import UserError, RedirectWarning, AccessError
from nwos.tests import tagged
from nwos.tools import zeep
...
class TestL10nEsEdiVerifactuDocument(TestL10nEsEdiVerifactuCommon):
    ...
    def test_generation_error(self):
        check_function_path = 'nwos.addons.l10n_es_edi_verifactu.models.verifactu_document.L10nEsEdiVerifactuDocument._check_record_values'
