...
import nwos
import nwos.tools
from nwos.exceptions import AccessDenied, AccessError
from nwos.http import _request_stack
from nwos.service import common as auth
from nwos.service import model
from nwos.tests import common
from nwos.tools import DotDict, mute_logger

from nwos.addons.base.tests.common import SavepointCaseWithUserDemo
...
class TestXMLRPC(common.HttpCase):
    ...
    def setUp(self):
        ...
        ml_xml = mute_logger('nwos.addons.rpc.controllers.xmlrpc')
        ml_xml.__enter__()  # noqa: PLC2801
        self.addCleanup(ml_xml.__exit__)

        ml_json = mute_logger('nwos.addons.rpc.controllers.jsonrpc')
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   nwos.api.model(lambda *_: collections.defaultdict(int)))
