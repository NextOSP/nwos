...
from nwos.tests import tagged, common, Form, HttpCase
from nwos.tools import float_compare, float_is_zero
...
class TestRepairHttp(HttpCase):
    ...
    def test_repair_without_product_in_parts(self):
        ...
        self.start_tour(f"/nwos/repairs/{repair.id}", "test_repair_without_product_in_parts", login='admin')
        self.assertTrue(repair.has_uncomplete_moves)
