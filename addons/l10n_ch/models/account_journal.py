...
from nwos import models, fields, api

from nwos.exceptions import ValidationError

from nwos.addons.base_iban.models.res_partner_bank import validate_iban
...
class AccountJournal(models.Model):
    ...
    ], ondelete={'ch': lambda recs: recs.write({'invoice_reference_model': 'nwos'})})
