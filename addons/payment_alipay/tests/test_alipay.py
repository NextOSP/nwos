...
from nwos.addons.payment_alipay.controllers.main import AlipayController
from nwos.addons.payment_alipay.tests.common import AlipayCommon
...
class AlipayTest(AlipayCommon, PaymentHttpCommon):
    ...
    @mute_logger('nwos.addons.payment_alipay.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'nwos.addons.payment_alipay.controllers.main.AlipayController'
