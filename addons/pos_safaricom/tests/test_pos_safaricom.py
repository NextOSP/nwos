...
class TestPosSafaricom(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        with patch('nwos.addons.pos_safaricom.models.pos_payment_method.PosPaymentMethod.lipa_na_mpesa_register_urls'):
    ...
    @patch('requests.post')
    @patch('nwos.addons.pos_safaricom.models.pos_payment_method.PosPaymentMethod._get_bearer_token')
