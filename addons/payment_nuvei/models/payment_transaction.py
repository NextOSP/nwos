...
from nwos.addons.payment_nuvei import const
from nwos.addons.payment_nuvei.controllers.main import NuveiController
...
class PaymentTransaction(models.Model):
    ...
    def _extract_amount_data(self, payment_data):
        ...
        # is sent back to nwos via the endpoint. As such there is no currency or
