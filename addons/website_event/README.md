...
Organize, promote and sell events online. Whether you organize meetings, conferences, trainings or webinars, NWOS gives you all the features you need to manage your events.
...
NWOS's unique *'edit inline'* approach makes website creation surprisingly easy. "Want to introduce a speaker? to change the price of a ticket? to update a banner? promote sponsors?" just click and change.
...
Get a clear visibility of your sales funnel. NWOS's Google Analytics trackers are configured by default to track all kind of events related to shopping carts, call-to-actions, etc.

As NWOS marketing tools (mass mailing, campaigns, etc) are also linked with Google Analytics, you get a full view of your business.
...
### Designers love working on NWOS
...
SEO tools are ready to use, with no configuration required. NWOS suggests keywords according to Google most searched terms, Google Analytics tracks your shopping cart events and sitemap are created automatically.
...
Create new landing pages easily with the NWOS inline editing feature. Send visitors of your different marketing campaigns to event landing pages to optimize conversions.
...
createdb nwos
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -i website_event
```
...
```bash
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -u website_event
```
