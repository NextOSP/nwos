...
from nwos.addons.l10n_jo_edi.tests.test_jo_edi_precision import TestJoEdiPrecision
from nwos.addons.l10n_jo_edi_pos.tests.jo_edi_pos_common import JoEdiPosCommon
