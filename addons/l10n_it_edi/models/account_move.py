...
from nwos.addons.base.models.ir_qweb_fields import Markup, nl2br, nl2br_enclose
from nwos.exceptions import LockError, UserError
from nwos.fields import Domain
from nwos.tools import cleanup_xml_node, float_compare, float_is_zero, float_repr, float_round, html2plaintext
from nwos.tools.sql import column_exists, create_column

from stdnum.it import codicefiscale, iva

from nwos import _, api, Command, fields, models, modules
from nwos.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
from nwos.addons.l10n_it_edi.models.account_payment_method_line import L10N_IT_PAYMENT_METHOD_SELECTION
from nwos.addons.l10n_it_edi.tools.remove_signature import remove_signature
...
class AccountMove(models.Model):
    ...
    def _l10n_it_edi_add_base_lines_xml_values(self, base_lines_aggregated_values, is_downpayment):
        ...
        for index, (base_line, aggregated_values) in enumerate(base_lines_aggregated_values, start=1):
            ...
            # This deviates from NWOS's standard behavior and must be reviewed if the issue gets fixed.
    ...
    def _l10n_it_edi_import_invoice(self, invoice, data, is_new):
        """ Decode a FatturaPA attachment into an NWOS move.
