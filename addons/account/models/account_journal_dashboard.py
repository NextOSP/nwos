...
from nwos import models, api, _, fields, tools
from nwos.exceptions import UserError
from nwos.fields import Command, Domain
from nwos.release import version
from nwos.tools import DEFAULT_SERVER_DATE_FORMAT as DF, SQL
from nwos.tools.misc import formatLang, format_date as nwos_format_date, get_lang
...
class AccountJournal(models.Model):
    ...
    def _transform_activity_dict(self, activity_data):
        return {
            ...
            'date': nwos_format_date(self.env, activity_data['date_deadline']),
        }
