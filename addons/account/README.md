...
The NWOS <a href="https://www.nwos.com/app/accounting">Open Source Accounting</a> app allows a better way to
...
in one place. NWOS's user interface is designed with productivity in mind.
...
accounting; NWOS has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

NWOS supports multiple currencies, multiple users with different access rights,
...
createdb nwos
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -i account
```
...
```bash
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -u account
```
