...
from nwos.addons.account.tests.test_account_journal_dashboard_common import TestAccountJournalDashboardCommon
from nwos.tests import tagged
from nwos.tools.misc import format_amount
