...
from nwos.tests import Form, HttpCase, new_test_user, tagged, save_test_file
from nwos.tools import config, file_path, file_open
from nwos.tools.float_utils import float_round

from nwos.addons.product.tests.common import ProductCommon
...
class AccountTestInvoicingCommon(ProductCommon):
    ...
    def _assert_iap_valid_xml(self, xml_element: str | bytes | etree._Element):
        ...
        # Get file details
        details_response = requests.post(url='https://iap-services.nwos.com/file_validator/get/details', json=common_payload, timeout=5)
        ...
        xsd_response = requests.post(url='https://iap-services.nwos.com/file_validator/validate/xsd', json=xsd_payload, timeout=5)
        ...
        with requests.Session() as session:
            for schematron_name in details_json['schematrons']:
                ...
                schematron_response = session.post(url='https://iap-services.nwos.com/file_validator/validate/schematron', json=schematron_payload, timeout=5)
