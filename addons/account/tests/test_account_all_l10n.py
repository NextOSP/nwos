...
from nwos.tools import make_index_name, SQL
from nwos.tools.translate import TranslationImporter
from nwos.tests import standalone
from nwos.addons.account.models.chart_template import AccountChartTemplate
...
def test_all_l10n(env):
    ...
    logger = logging.getLogger('nwos.loading')
