...
class L10nHuEdiConnection:
    def __init__(self, env):
        ...
        :param env: the NWOS environment
        """
        self.env = env
    ...
    def do_token_exchange(self, credentials):
        ...
        try:
            # Convert into a naive UTC datetime, since NWOS can't store timezone-aware datetimes
    ...
    def _get_header_values(self, credentials, invoice_hashs=None):
        ...
        request_id = 'NWOS' + secrets.token_hex(13)
        ...
        return {
            ...
            'softwareName': 'NWOS Enterprise',
            'softwareOperation': 'ONLINE_SERVICE',
            'softwareMainVersion': nwos_version,
            'softwareDevName': 'NWOS',
            'softwareDevContact': 'andu@nwos.com',
