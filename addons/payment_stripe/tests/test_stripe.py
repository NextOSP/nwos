...
from nwos.tools.urls import urljoin as url_join

from nwos.addons.payment.tests.http_common import PaymentHttpCommon
from nwos.addons.payment_stripe import const
from nwos.addons.payment_stripe.controllers.main import StripeController
from nwos.addons.payment_stripe.tests.common import StripeCommon
...
class StripeTest(StripeCommon, PaymentHttpCommon):
    ...
    def test_processing_values(self):
        ...
        ), mute_logger('nwos.addons.payment.models.payment_transaction'):
    ...
    @mute_logger('nwos.addons.payment_stripe.models.payment_transaction')
    ...
    @mute_logger('nwos.addons.payment_stripe.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        """ Test the processing of a webhook notification. """
        tx = self._create_transaction('redirect')
        url = self._build_url(StripeController._webhook_url)
        with patch(
            'nwos.addons.payment_stripe.controllers.main.StripeController._verify_signature'
        ):
    ...
    def test_validate_amount_succeeds_for_special_currencies(self):
        for currency_code in const.CURRENCY_DECIMALS:
            ...
            with patch(
                'nwos.addons.payment_stripe.models.payment_transaction.PaymentTransaction'
    ...
    def test_webhook_notification_tokenizes_payment_method(self):
        ...
        with patch(
            ...
            'nwos.addons.payment.models.payment_transaction.PaymentTransaction._tokenize'
    ...
    def test_onboarding_action_redirect_to_url(self):
        ...
        if country := self.env['res.country'].search([('code', 'in', list(const.SUPPORTED_COUNTRIES))], limit=1):
            ...
            raise unittest.SkipTest("Unable to find a country supported by both nwos and stripe")
