...
from nwos.tests import Form, common
from nwos.tools import float_compare, mute_logger

from nwos.addons.sale.tests.common import TestSaleCommon
from nwos.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import (
...
class TestSaleMrpFlow(TestSaleMrpFlowCommon):
    ...
    @mute_logger('nwos.tests.common.onchange')
