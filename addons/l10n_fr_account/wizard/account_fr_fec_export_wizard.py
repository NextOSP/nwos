...
from nwos.tools import float_is_zero, SQL
from nwos import fields, models, api
...
class L10n_FrFecExportWizard(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # 1) the XSD file impose to have the label on the account.move, but NWOS has the label on the account.move.line,
        # so that's a  problem !
