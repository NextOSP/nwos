...
from nwos.tools import date_utils, mute_logger
from nwos.tests import Form, tagged, users

from nwos.addons.hr_holidays.tests.common import TestHrHolidaysCommon
...
class TestLeaveRequests(TestHrHolidaysCommon):
    ...
    def test_calendar_event_create_access_rights(self):
        ...
        self.env['ir.model.access'].create([
            ...
            # https://github.com/nwos/nwos/blob/cc0060e889603eb2e47fa44a8a22a70d7d784185/addons/calendar/models/calendar_event.py#L734
            {
            ...
            # https://github.com/nwos/nwos/blob/cc0060e889603eb2e47fa44a8a22a70d7d784185/addons/calendar/models/calendar_event.py#L786
            # https://github.com/nwos/nwos/blob/cc0060e889603eb2e47fa44a8a22a70d7d784185/addons/calendar/models/calendar_event.py#L882
            {
            ...
            # https://github.com/nwos/nwos/blob/cc0060e889603eb2e47fa44a8a22a70d7d784185/addons/hr_holidays/models/hr_leave.py#L894-L898
            ...
            # Read and create acess on `calendar.event` for portal required for
            # https://github.com/nwos/nwos/blob/cc0060e889603eb2e47fa44a8a22a70d7d784185/addons/calendar/models/calendar_event.py#L760-L768
            # Write and unlink added to match the customer customization + out of common sense,
