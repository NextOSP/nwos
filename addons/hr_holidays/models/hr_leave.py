...
from nwos.addons.resource.models.utils import HOURS_PER_DAY
...
from nwos.tools.date_utils import float_to_time
from nwos.fields import Command, Date, Domain
from nwos.tools.float_utils import float_round, float_compare
from nwos.tools.intervals import Intervals
from nwos.tools.misc import clean_context, format_date
        ...
        for holiday in holidays:
            if not self.env.context.get('leave_fast_create'):
                ...
                if holiday.validation_type == 'no_validation':
                    ...
                    holiday_sudo.message_post(body=_("The time off has been automatically approved"), subtype_xmlid="mail.mt_comment") # Message from NWOSBot (sudo)
