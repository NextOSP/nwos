...
class TestStructure(TransactionCase):
    ...
    def test_parent_validation(self):
        ...
        with patch('nwos.addons.base_vat.models.res_partner.ResPartner._check_vies_iap', TestStructure._check_vies_iap):
    ...
    def test_no_vies_revalidation_when_creating_company_from_contact(self):
        ...
        with patch('nwos.addons.base_vat.models.res_partner.ResPartner._check_vies_iap',
