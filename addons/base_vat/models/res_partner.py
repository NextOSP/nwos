...
from nwos import api, models, fields, _, tools, modules
from nwos.tools import LazyTranslate, hash_sign
from nwos.exceptions import ValidationError, UserError
from nwos.addons.base.models.res_partner import EU_EXTRA_VAT_CODES
...
class ResPartner(models.Model):
    ...
    def _get_iap_vies_endpoint(self):
        prod, test = 'https://vies.api.nwos.com', 'https://vies.test.nwos.com'
