...
from nwos.addons.hw_drivers.websocket_client import WebsocketClient
...
class Manager(Thread):
    def send_alldevices(self, iot_client=None):
        """
        This method send IoT Box and devices informations to NWOS database
        """
    ...
    def run(self):
        """
        Thread that will load interfaces and drivers and contact the nwos server with the updates
        """
        helpers.migrate_old_config_files_to_new_config_file()
        server_url = helpers.get_nwos_server_url()
