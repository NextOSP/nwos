...
class ConnectionManager(Thread):
    ...
    def run(self):
        if not helpers.get_nwos_server_url() and not helpers.access_point():
    ...
    def _connect_box(self):
        ...
        try:
            ...
            req = requests.post('https://iot-proxy.nwos.com/nwos-enterprise/iot/connect-box', json=data, verify=False)
