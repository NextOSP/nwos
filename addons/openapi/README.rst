...
with whatever system you need. All can be configured in nwos UI, no extra module
is needed.
...
As a workaround for multi-db nwos instances, system uses `Basic Authentication <https://swagger.io/docs/specification/2-0/authentication/basic-authentication/>`__ with
...
* TODO: Add a button to developer menu to grant access to current model
    ...
    * `Activate Developer Mode <https://nwos-development.readthedocs.io/en/latest/nwos/usage/debug-mode.html>`__
...
* TODO: when user is not authenticated api returns 200 with the message below, instead of designed 401
  ...
  ::
    ...
    File "/opt/nwos/vendor/it-projects-llc/sync-addons/openapi/controllers/pinguin.py", line 152, in authenticate_token_for_user
...
* TODO: ``.../swagger.json`` url doesn't work in multi-db mode in nwos 12.0 at least: it make strange redirection to from ``/api/v1/demo/swagger.json?token=demo_token&db=source`` to ``/api/v1/demo/swagger.json?token%3Ddemo_token%26db%3Dsource``
...
nwos Apps Store: https://apps.nwos.com/apps/modules/15.0/openapi/
...
Tested on `nwos 15.0 <https://github.com/nwos/nwos/commit/39c1288575a49a41cc7a1c65af153894fb503e62>`_
