...
* `Install <https://nwos-development.readthedocs.io/en/latest/nwos/usage/install-module.html>`__ this module in a usual way
...
Note:
  The Swagger Editor sends requests directly from browser which leads to CORS error and work with it is not available in `nwos.sh`.
