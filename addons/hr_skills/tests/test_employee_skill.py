...
# |   1 |  Certificate |     NWOS |  |     1 |  Certificate |       20% |                               0 |
...
# |    1 |  Certificate |    NWOS |     50% |        True  |     24-03-02 |           - |
# |    2 |  Certificate |    NWOS |     20% |        True  |     24-01-01 |    24-04-01 | <- not present in current_employee_skill (because a valid certification for this skill exist)
...
# |-------------------------------------------------------------------------------------|
    ...
    def test_edit_nwos_50_stop_date(self):
        employee_form = Form(self.employee)
        previous_employee_skills = self.employee.employee_skill_ids
    ...
    def test_edit_arabic_a2_to_nwos_50_from_1_jan_to_1_june(self):
        employee_form = Form(self.employee)
        previous_employee_skills = self.employee.employee_skill_ids
    ...
    def test_add_nwos_50_from_2_mar_to_infinite(self):
        employee_form = Form(self.employee)
        previous_employee_skills = self.employee.employee_skill_ids
        with employee_form.current_employee_skill_ids.new() as employee_skill_form:
            employee_skill_form.skill_type_id = self.certification
    ...
    def test_add_nwos_70_from_1_jan_1_mar(self):
        self.assertEqual(
        ...
        with employee_form.current_employee_skill_ids.new() as employee_skill_form:
            ...
            employee_skill_form.valid_from = datetime.date(2024, 1, 1)  # so same as nwos 20%
            employee_skill_form.valid_to = datetime.date(2024, 4, 1)  # so same as nwos 20%
    ...
    def test_add_nwos_50_from_1_jan_to_infinite(self):
        self.assertEqual(
            len(self.employee.employee_skill_ids.ids),
            5,
            "The test employee should have 5 skills",
        ...
        with employee_form.current_employee_skill_ids.new() as employee_skill_form:
            employee_skill_form.skill_type_id = self.certification
            employee_skill_form.skill_id = self.certification.skill_ids[0]
            employee_skill_form.skill_level_id = self.certification.skill_level_ids[1]  # so same as nwos 50%
