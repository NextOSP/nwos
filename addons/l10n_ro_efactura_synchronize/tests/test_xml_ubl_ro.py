...
from nwos.addons.l10n_ro_edi.tests.test_xml_ubl_ro import TestUBLROCommon

from nwos.addons.l10n_ro_efactura_synchronize.models.account_move import HOLDING_DAYS
    ...
    answer_data = {
        ...
        '3030439533': {
            ...
            'invoice': {
                ...
                'attachment_raw': file_open("l10n_ro_efactura_synchronize/tests/test_files/from_nwos/ciusro_in_invoice.xml").read(),
            },
        },
        '3029027563': {
...
@patch('nwos.addons.l10n_ro_efactura_synchronize.models.ciusro_document.L10nRoEdiDocument._request_ciusro_synchronize_invoices', new=_patch_request_ciusro_synchronize_invoices)
