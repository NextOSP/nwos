...
from nwos import _, api, fields, models, tools, SUPERUSER_ID
from nwos.addons.account_edi_ubl_cii.models.account_edi_common import SUPPORTED_FILE_TYPES
from nwos.tools import cleanup_xml_node
from nwos.tools.pdf import NWOSPdfFileReader, NWOSPdfFileWriter
...
class AccountMoveSend(models.AbstractModel):
    ...
    def _hook_invoice_document_after_pdf_report_render(self, invoice, invoice_data):
        ...
        reader = NWOSPdfFileReader(reader_buffer, strict=False)

        # Post-process.
        writer = NWOSPdfFileWriter()
