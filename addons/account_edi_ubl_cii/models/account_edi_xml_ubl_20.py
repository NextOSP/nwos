...
from nwos import _, models, Command
from nwos.tools import html2plaintext
from nwos.tools.float_utils import float_is_zero, float_round
from nwos.addons.account.tools import dict_to_xml
from nwos.addons.account_edi_ubl_cii.models.account_edi_common import EAS_MAPPING, FloatFmt
from nwos.addons.account_edi_ubl_cii.tools import Invoice, CreditNote, DebitNote
from nwos.addons.account_edi_ubl_cii.tools.ubl_20_optional_fields import PEPPOL_INVOICE_OPTIONAL_FIELDS, PEPPOL_INVOICE_OPTIONAL_LINE_FIELDS, PEPPOL_CREDIT_NOTE_OPTIONAL_FIELDS, PEPPOL_CREDIT_NOTE_OPTIONAL_LINE_FIELDS
    ...
    def _add_invoice_payment_terms_nodes(self, document_node, vals):
        ...
        if payment_term:
            document_node['cac:PaymentTerms'] = {
                # The payment term's note is automatically embedded in a <p> tag in NWOS
