...
from nwos import _, api, models
from nwos.addons.account.tools import dict_to_xml
from nwos.addons.base.models.res_bank import sanitize_account_number
from nwos.exceptions import UserError, ValidationError
from nwos.tools import float_compare, float_is_zero, float_repr
from nwos.tools.float_utils import float_round
from nwos.tools.misc import clean_context, formatLang, html_escape
from nwos.tools.xml_utils import find_xml_value
...
class AccountEdiCommon(models.AbstractModel):
    ...
    def _import_invoice_ubl_cii(self, invoice, file_data, new=False):
        ...
        # This has to be done after the first import in order to let NWOS compute the taxes before overriding if needed.
        with invoice._get_edi_creation() as invoice:
    ...
    def _retrieve_line_vals(self, tree, document_type=False, qty_factor=1):
        """
        Read the xml invoice, extract the invoice line values, compute the nwos values
        ...
        It is not possible to do it in NWOS.
        """
    ...
    def _retrieve_taxes(self, record, line_values, tax_type, tax_exigibility=None):
        ...
        In a UBL/CII xml, the NWOS "price_include" concept does not exist. Hence, first look for a price_include=False,
    ...
    def _retrieve_line_charges(self, record, line_values, taxes):
        ...
        Special case: if the ReasonCode == 'AEO', there is a high chance the xml was produced by NWOS and the
