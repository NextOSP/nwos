...
from nwos.addons.base.models.ir_qweb_fields import nl2br
from nwos.addons.mail.tools.discuss import add_guest_to_context, Store
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/nwos_ui_icons', type='http', auth='none', cors="*")
    def nwos_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/nwos_ui_icons/fonts/nwos_ui_icons.woff2').get_response()
