...
from nwos.addons.im_livechat.tests import chatbot_common
from nwos.tests.common import JsonRpcException, new_test_user, tagged
from nwos.tools.misc import mute_logger
from nwos.addons.mail.tests.common import freeze_all_time, MailCommon
...
class ChatbotCase(MailCommon, chatbot_common.ChatbotCase):
    ...
    def test_chatbot_steps(self):
        ...
        with self.assertRaises(JsonRpcException, msg='nwos.exceptions.ValidationError'), mute_logger("nwos.http"):
    ...
    def test_forward_to_specific_operator(self):
        ...
        self.assertEqual(discuss_channel.name, "NWOSBot Ernest Employee")
    ...
    def test_chatbot_clear_answers_on_step_type_change(self):
        ...
        self.start_tour(f"/nwos/action-{action.id}", 'change_chatbot_step_type', login='admin')
