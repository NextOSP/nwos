...
from nwos.addons.im_livechat.tests.common import TestImLivechatCommon
from nwos.addons.im_livechat.tests.test_get_operator import TestGetOperator
...
class TestImLivechatChannel(TestImLivechatCommon, TestGetOperator):
    ...
    def test_review_link(self):
        ...
        self.livechat_channel.review_link = "https://www.nwos.com"
        self.assertEqual(self.livechat_channel.review_link, "https://www.nwos.com")
