...
from nwos.addons.bus.websocket import WebsocketConnectionHandler
...
class Im_LivechatChannel(models.Model):
    """ Livechat Channel
        ...
        external website), 'script_internal' (code to be integrated with nwos website) or via 'web_page' link.
