...
from nwos import _, fields
from nwos.exceptions import ValidationError
from nwos.http import Controller, request, route
...
class MercadoPagoOnboardingController(Controller):
    ...
    def mercado_pago_return_from_authorization(self, **data):
        ...
        # Retrieve the Mercado Pago data and NWOS metadata from the redirect data.
        ...
        redirect_url = f'/nwos/action-{action.id}/{int(provider_sudo.id)}'
