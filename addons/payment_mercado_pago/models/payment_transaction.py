...
from nwos.addons.payment.const import CURRENCY_MINOR_UNITS
from nwos.addons.payment.logging import get_payment_logger
from nwos.addons.payment_mercado_pago import const
...
class PaymentTransaction(models.Model):
    ...
    def _apply_updates(self, payment_data):
        ...
        for nwos_code, mp_codes in const.PAYMENT_METHODS_MAPPING.items():
            if any(payment_method_type == mp_code for mp_code in mp_codes.split(',')):
                payment_method_type = nwos_code
                break
        ...
        # the user might have picked a different payment method than on NWOS's payment form.
