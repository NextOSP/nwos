...
from nwos.exceptions import RedirectWarning, ValidationError
...
from nwos.addons.payment.const import REPORT_REASONS_MAPPING
...
class PaymentProvider(models.Model):
    ...
    def _compute_mercado_pago_is_oauth_supported(self):
        """Return current state of OAuth support by NWOS. To be removed in future versions."""
