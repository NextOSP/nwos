...
from nwos import _, api, Command, fields, models
from nwos.tools import OrderedSet, float_is_zero
...
class StockMove(models.Model):
    ...
    manual_consumption = fields.Boolean(
        ...
        help="When activated, then the registration of consumption for that component is recorded manually exclusively.\n"
             "If not activated, and any of the components consumption is edited manually on the manufacturing order, NWOS assumes manual consumption also.")
