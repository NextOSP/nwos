...
from nwos import exceptions, fields
from nwos.exceptions import UserError
from nwos.fields import Command
from nwos.tests import Form, HttpCase, freeze_time, tagged
from nwos.tools import float_compare, float_repr, float_round

from nwos.addons.mrp.tests.common import TestMrpCommon
...
class TestBoM(TestMrpCommon):
    ...
    def test_cycle_on_bom_sequencing(self):
        ...
        # (see nwos/addons/web/controllers/main.py:1352)
...
class TestTourBoM(HttpCase):
    ...
    def test_mrp_bom_product_catalog(self):
        ...
        url = f'/nwos/action-mrp.mrp_bom_form_action/{self.bom.id}'
    ...
    def test_manufacture_from_bom(self):
        ...
        """
        url = '/nwos/action-mrp.mrp_bom_form_action'
