...
from nwos.addons.mail_group.tests.data import GROUP_TEMPLATE
from nwos.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('nwos.models.unlink', 'nwos.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('nwos.addons.base.models.ir_rule', 'nwos.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('nwos.addons.mail.models.mail_thread', 'nwos.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('nwos.addons.mail.models.mail_thread', 'nwos.addons.mail_group.models.mail_group_message', 'nwos.models.unlink')
    @users('employee')
    ...
    @mute_logger('nwos.addons.mail_group.models.mail_group')
    @users('employee')
