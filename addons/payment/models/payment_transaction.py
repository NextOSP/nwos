...
from nwos.tools import email_normalize_all, float_round

from nwos.addons.payment import utils as payment_utils
from nwos.addons.payment.const import CURRENCY_MINOR_UNITS, SENSITIVE_KEYS
...
class PaymentTransaction(models.Model):
    ...
    def _validate_amount(self, payment_data):
        ...
        # Negate the amount for refunds, as refunds have a negative amount in NWOS, but all
    ...
    def _send_api_request(self, method, endpoint, *, params=None, data=None, json=None, **kwargs):
        ...
        1. Pass the transaction reference to the provider's
           :meth:`~nwos.addons.payment.models.payment_provider.PaymentProvider._send_api_request`
           method.
