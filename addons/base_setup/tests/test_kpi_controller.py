...
from nwos import fields, release
from nwos.addons.base_setup.controllers import kpi as kpi_controller
from nwos.tests import HttpCase, new_test_user, patch, tagged, TransactionCase
...
class KpiTest(HttpCase):
    ...
    def setUpClass(cls):
        ...
        cls.startClassPatcher(patch('nwos.addons.base_setup.controllers.kpi.db_connect',
    ...
    def setUp(self):
        ...
        self.mock_kpi_providers = self.startClassPatcher(patch('nwos.addons.base_setup.controllers.kpi._get_kpi_providers',
                                                               return_value=[]))
    ...
    def test_get_kpi_summary_on_nonexistant_database(self):
        ...
        self.startPatcher(patch('nwos.addons.base_setup.controllers.kpi.db_connect', side_effect=OperationalError))

        params = {
            'credentials': [['missing-database', 'any_token']],
        }
        with self.assertNoLogs('nwos.addons.base_setup.controllers.kpi', level='ERROR'):
            result = self._make_json_request('/kpi/summary', json={'params': params})
    ...
    def test_get_kpi_summary_with_invalid_credential(self):
        ...
        with self.assertLogs('nwos.addons.base_setup.controllers.kpi', level='ERROR') as log_catcher:
            result = self._make_json_request('/kpi/summary', json={'params': params})
    ...
    def test_get_kpi_summary_with_version_mismatch(self):
        ...
        self.startPatcher(patch('nwos.addons.base_setup.controllers.kpi.release_series', new='saas~9.11'))
    ...
    def test_get_kpi_summary_limits_credentials_count(self):
        ...
        with self.assertLogs('nwos.http', 'WARNING') as log_catcher:
...
class TestKpiProviderLoading(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        fake_module.__name__ = "nwos.addons.test_addon.sub.module"
        ...
        fake_root_module.__name__ = "nwos.addons.test_addon"
    ...
    def test_get_kpi_providers_parsing_and_filtering(self):
        with self.assertLogs('nwos.addons.base_setup.controllers.kpi', level='WARNING') as log_catcher:
