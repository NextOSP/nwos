...
from nwos.addons.l10n_pl_bank_verification.tests.utils.utils import FakeResponse
...
class TestL10nPlBankAccountVerification(AccountTestInvoicingCommon):
    ...
    @patch('nwos.addons.l10n_pl_bank_verification.models.bank_account_verification.BankAccountVerification._make_request', _make_request_patched)
    ...
    @patch('nwos.addons.l10n_pl_bank_verification.models.bank_account_verification.BankAccountVerification._make_request')
