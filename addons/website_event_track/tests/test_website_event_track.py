...
from nwos.addons.website_event.tests.common import TestEventOnlineCommon
from nwos.tests.common import HttpCase, freeze_time, tagged
    ...
    def test_email_reminder_tour(self):
        ...
        for user in [self.demo_user, self.env['res.users']]:
            with self.subTest(user=user):
                ...
                ]).mail_ids.filtered(lambda m: m.email_to == (user.email or "visitor@nwos.com"))
