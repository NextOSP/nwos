...
from nwos import _, api, exceptions, fields, models
from nwos.exceptions import LockError, MissingError
from nwos.fields import Domain
from nwos.http import request
from nwos.tools import safe_eval
...
def _get_domain_fields(env, model, domain):
    ...
    # see: https://github.com/nwos/nwos/pull/189772#issuecomment-2548804283
