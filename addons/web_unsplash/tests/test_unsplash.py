...
from nwos.tests import JsonRpcException, patch

from nwos.addons.base.tests.common import HttpCaseWithUserDemo, Mock
...
class TestUnsplashHttp(HttpCaseWithUserDemo):
    ...
    def test_access(self):
        ...
        with patch.object(requests, 'get', self._mocked_save_unsplash_url):
            ...
            with self.assertLogs("nwos.http", level="WARNING") as log_catcher, \
                 self.assertRaisesRegex(JsonRpcException, "nwos.exceptions.AccessError"):
            ...
            self.assertEqual(
                ...
                "WARNING:nwos.http:Sorry, you are not allowed to access this document.",
            )
