...
from nwos.addons.payment_razorpay import const
from nwos.addons.payment_razorpay.controllers.main import RazorpayController
...
class PaymentTransaction(models.Model):
    ...
    def _send_void_request(self):
        ...
        raise UserError(_("Transactions processed by Razorpay can't be manually voided from NWOS."))
    ...
    def _search_by_reference(self, provider_code, payment_data):
        ...
        if entity_type == 'payment':
            ...
            if reference:  # The refund was initiated from NWOS.
                tx = self.search([('reference', '=', reference), ('provider_code', '=', 'razorpay')])
    ...
    def _apply_updates(self, payment_data):
        ...
        if entity_status in const.PAYMENT_STATUS_MAPPING['pending']:
            ...
            if (
                ...
                # In case the tokenization was requested on provider side not from nwos form.
                self.tokenize = True
            self._set_done()
