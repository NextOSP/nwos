...
from nwos.addons.payment_razorpay.const import HANDLED_WEBHOOK_EVENTS
...
class RazorpayController(http.Controller):
    ...
    def razorpay_return_from_checkout(self, reference, **data):
        ...
        The route is configured with save_session=False to prevent NWOS from creating a new session
        ...
        the payment provider to NWOS. However, the redirection to the /payment/status page will
