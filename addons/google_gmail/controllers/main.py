...
from nwos.tools import consteq, email_normalize
from nwos.addons.google_gmail.models.google_gmail_mixin import GMAIL_TOKEN_REQUEST_TIMEOUT
...
class GoogleGmailController(http.Controller):
    ...
    def _get_redirect_url(self, record):
        ...
        if (
            ...
            return f'/nwos/{record._name}/{record.id}'
        return f'/nwos/my-preferences/{request.env.user.id}'
