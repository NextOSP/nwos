...
from nwos.tools import file_open, mute_logger

from nwos.addons.account.tests.common import AccountTestInvoicingCommon
from nwos.addons.l10n_my_edi.tests.test_file_generation import NS_MAP
from nwos.addons.point_of_sale.tests.common import TestPoSCommon

CONTACT_PROXY_METHOD = 'nwos.addons.l10n_my_edi.models.account_edi_proxy_user.AccountEdiProxyClientUser._l10n_my_edi_contact_proxy'
...
class TestMyInvoisPoS(TestPoSCommon):
    ...
    @mute_logger('nwos.addons.point_of_sale.models.pos_order')
    ...
    def test_consolidate_invoices_limit(self):
        ...
        with freeze_time("2025-01-01"):
            ...
            with patch('nwos.addons.l10n_my_edi_pos.wizard.myinvois_consolidate_invoice_wizard.MAX_LINE_COUNT_PER_INVOICE', 1):
                # Consolidate them
                wizard = self.env['myinvois.consolidate.invoice.wizard'].create({
                    'date_from': '2025-01-01',
                    'date_to': '2025-01-31',
    ...
    @mute_logger('nwos.addons.point_of_sale.models.pos_order', 'nwos.addons.point_of_sale.models.pos_session')
    ...
    def test_consolidate_invoices_refund_with_customer(self):
        """
        When an order has a customer set, NWOS enforces that the refund must use the same customer.
        In the case of consolidated invoices, this does not make sense. So while we let NWOS set the correct customer,
