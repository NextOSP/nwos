...
from nwos.tests import HttpCase, new_test_user, tagged
...
class TestExpensesAccessRights(TestExpenseCommon, HttpCase):
    ...
    def test_expense_access_rights_user(self):
        ...
        self.start_tour("/nwos", 'hr_expense_access_rights_test_tour', login="test-expense")
    ...
    def test_expense_create_and_post_message_on_submitted_and_approved(self):
        ...
        with mute_logger('nwos.addons.web.controllers.binary'):  # To avoid logging the AccessError raised when trying to upload the attachment.
