...
from nwos.addons.payment_ecpay import const
from nwos.addons.payment_ecpay.controllers.main import EcpayController
from nwos.addons.payment_ecpay.tests.common import EcpayCommon
...
class TestProcessingFlows(EcpayCommon, PaymentHttpCommon):
    ...
    @mute_logger("nwos.addons.payment_ecpay.controllers.main")
    def test_returning_from_payment_triggers_processing(self):
        ...
        with (
            patch("nwos.addons.payment_ecpay.controllers.main.EcpayController._verify_signature"),
            patch(
    ...
    def test_webhook_triggers_signature_check(self):
        ...
        with (
            patch(
                "nwos.addons.payment_ecpay.controllers.main.EcpayController._verify_signature"
