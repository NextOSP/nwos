...
from nwos.addons.l10n_account_edi_ubl_cii_tests.tests.common import TestUBLCommon
...
class TestUBLDKOIOUBL21(TestUBLCommon, TestAccountMoveSendCommon):
    ...
    def _send_patched(cls, invoice):
        ...
        with patch('nwos.addons.l10n_dk_nemhandel.models.res_partner.ResPartner._get_nemhandel_verification_state', return_value='valid'), \
    ...
    def test_export_invoice_partner_dk(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_nwos/oioubl_out_invoice_partner_dk.xml")
    ...
    def test_export_invoice_foreign_partner_be(self):
        ...
        self.assertTrue(invoice.ubl_cii_xml_id)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_nwos/oioubl_out_invoice_foreign_partner_be.xml")

    @freeze_time('2017-01-01')
    def test_export_invoice_foreign_partner_fr(self):
        invoice = self.create_post_and_send_invoice(partner=self.partner_c)
        self.assertTrue(invoice.ubl_cii_xml_id)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_nwos/oioubl_out_invoice_foreign_partner_fr.xml")
    ...
    def test_export_credit_note_partner_dk(self):
        ...
        self._assert_invoice_attachment(refund.ubl_cii_xml_id, xpaths=None, expected_file_path="from_nwos/oioubl_out_refund_partner_dk.xml")
    ...
    def test_export_credit_note_partner_fr(self):
        ...
        self.assertTrue(refund.ubl_cii_xml_id)
        self._assert_invoice_attachment(refund.ubl_cii_xml_id, xpaths=None, expected_file_path="from_nwos/oioubl_out_refund_foreign_partner_fr.xml")
    ...
    def test_oioubl_export_with_partner_child(self):
        ...
        self.assertTrue(invoice.ubl_cii_xml_id)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_nwos/oioubl_out_invoice_child_partner.xml")
    ...
    def test_oioubl_export_import_with_discount(self):
        ...
        self._send_patched(invoice)
        self.assertTrue(invoice.ubl_cii_xml_id)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_nwos/oioubl_out_invoice_discount.xml")
