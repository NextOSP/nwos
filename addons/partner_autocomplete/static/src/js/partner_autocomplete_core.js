...
import { onWillStart } from "@nwos/owl";
...
export function usePartnerAutocomplete() {
    const keepLastNWOS = new KeepLast();
    ...
    /**
     * Use NWOS Autocomplete API to return suggestions
     *
     * @param {string} value
     * @param {boolean} isVAT
     * @returns {Promise}
    ...
    async function getSuggestions(value, isVAT, queryCountryId) {
        ...
        const suggestions = await keepLastNWOS.add(prom);
