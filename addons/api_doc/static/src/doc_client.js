import { Component, useState, onMounted, useSubEnv } from "@nwos/owl";
...
export class DocClient extends Component {
    ...
    setup() {
        this.setTheme(localStorage.getItem("theme") || "nwos-dark");
    ...
    toggleTheme() {
        this.setTheme(this.theme === "nwos-dark" ? "nwos-light" : "nwos-dark");
    }
