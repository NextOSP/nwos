...
import nwos
from nwos import http, models
from nwos.api import Self
from nwos.exceptions import AccessError
from nwos.http import content_disposition, request
from nwos.modules.module_graph import ModuleGraph
from nwos.service.model import get_public_method
from nwos.tools import hmac, json_default, lazy_classproperty, py_to_js_locale
...
class DocController(http.Controller):
    ...
    def doc_index(self):
        ...
        if parse_cache_control_header(request.httprequest.headers.get('Cache-Control')).no_cache:
            ...
            return request.make_json_response(
                ...
                headers={
                    ...
                    'Content-Disposition': content_disposition('nwos-doc-index.json'),
        ...
        filename = f'nwos-doc-index-{db_registry_sequence}-{unique}.json'
...
DOC_API_MAGIC_COLUMNS = list(nwos.models.MAGIC_COLUMNS)
...
# works much better than nwos.tools.lazy.
class _DocUtils:
