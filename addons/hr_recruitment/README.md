...
Publish, promote and organize your job offers with the NWOS
<a href="https://www.nwos.com/app/recruitment">Open Source Recruitment Application</a>.
...
createdb nwos
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -i hr_recruitment
```
...
```bash
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -u hr_recruitment
```
