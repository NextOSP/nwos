...
from nwos.exceptions import UserError, AccessDenied
from nwos.modules.registry import Registry
from nwos.tools import float_is_zero, pycompat
...
class AccountFrFec(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # but NWOS has the label on the account.move.line, so that's a
        # problem !
