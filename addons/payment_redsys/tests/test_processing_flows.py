...
from nwos.addons.payment_redsys.tests.common import RedsysCommon


@tagged('post_install', '-at_install')
class TestProcessingFlows(RedsysCommon, PaymentHttpCommon):

    @mute_logger('nwos.addons.payment_redsys.controllers.main')
    def test_returning_from_payment_triggers_processing(self):
        ...
        with patch(
            'nwos.addons.payment_redsys.controllers.main.RedsysController._verify_signature',
        ), patch(
