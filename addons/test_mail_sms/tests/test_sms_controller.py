...
from nwos.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
...
class TestSmsController(TestSMSActionsCommon):
    ...
    @mute_logger("nwos.addons.base.models.ir_http")
    ...
    @mute_logger('nwos.addons.base.models.ir_http', 'nwos.addons.sms.controllers.main', 'nwos.http')
