...
from nwos.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE, MAIL_TEMPLATE_SHORT
from nwos.addons.test_mail.tests.common import TestRecipients
from nwos.tools.mail import formataddr
            ...
            [
                {
                    ...
                    # portal was already in email_to, hence not notified twice through nwos
                    'notif': [
