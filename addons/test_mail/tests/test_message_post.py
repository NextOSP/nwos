...
from nwos.addons.base.tests.test_ir_cron import CronMixinCase
from nwos.addons.mail.tests.common import mail_new_test_user, MailCommon
from nwos.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from nwos.addons.test_mail.models.test_mail_models import MailTestSimple
from nwos.addons.test_mail.tests.common import TestRecipients
from nwos.service.model import call_kw
from nwos.exceptions import AccessError
from nwos.tests import tagged
from nwos.tools import mute_logger, formataddr
from nwos.tests.common import users
...
class TestMessageNotify(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('nwos.addons.mail.models.mail_mail', 'nwos.models.unlink', 'nwos.tests')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    def test_message_post(self):
        ...
        exp_headers = {
            ...
            'X-NWOS-Objects': f'{test_record._name}-{test_record.id}',
        }
        with self.assertSinglePostNotifications(
                [
                    {'partner': self.partner_employee_2, 'type': 'inbox'},
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. nwosbot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
                ...
                with self.assertSinglePostNotifications(
                        ...
                        message_info={
                            ...
                            'mail_mail_values': {
                                'headers': {
                                    'Return-Path': f'{expected_alias_domain.bounce_alias}@{expected_alias_domain.name}',
                                    'X-NWOS-Objects': f'{record._name}-{record.id}',
                                },
                            },
                            'message_values': {
    ...
    @mute_logger('nwos.addons.mail.models.mail_mail', 'nwos.tests')
    ...
    @users('employee')
    @mute_logger('nwos.addons.mail.models.mail_mail', 'nwos.addons.mail.models.mail_message_schedule', 'nwos.models.unlink')
    ...
    @mute_logger('nwos.addons.mail.models.mail_mail', 'nwos.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('nwos.addons.base.models.ir_model', 'nwos.addons.mail.models.mail_mail')
