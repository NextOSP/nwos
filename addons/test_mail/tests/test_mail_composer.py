...
from nwos.addons.mail.wizard.mail_compose_message import MailComposeMessage
...
from nwos.fields import Datetime as FieldDatetime
from nwos.exceptions import AccessError, UserError
from nwos.tests import Form, tagged, users
from nwos.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('nwos.tests', 'nwos.addons.mail.models.mail_mail', 'nwos.models.unlink')
    ...
    @mute_logger('nwos.tests', 'nwos.addons.base.models.ir_rule', 'nwos.addons.mail.models.mail_mail', 'nwos.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('nwos.models.unlink', 'nwos.addons.mail.models.mail_mail', 'nwos.addons.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('nwos.models.unlink', 'nwos.addons.mail.models.mail_mail')
