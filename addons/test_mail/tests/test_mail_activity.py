...
from nwos import fields, exceptions, tests
from nwos.addons.mail.tests.common import mail_new_test_user
from nwos.addons.mail.tests.common_activity import ActivityScheduleCase
from nwos.addons.test_mail.models.test_mail_models import MailTestActivity
from nwos.tests import Form, HttpCase, users
from nwos.tests.common import freeze_time
...
class TestActivitySystray(TestActivityCommon, HttpCase):
    ...
    def test_systray_activities_for_various_records(self):
        ...
        self.assertEqual(len(test_with_removed), 4, 'Even with ACL check, activities linked to removed records are kept if assigned to the user (see nwos/nwos#112126)')
