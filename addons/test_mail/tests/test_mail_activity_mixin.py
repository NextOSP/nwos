...
from nwos import fields, tests
from nwos.addons.mail.models.mail_activity import MailActivity
from nwos.addons.mail.tests.common import mail_new_test_user
from nwos.addons.test_mail.tests.test_mail_activity import TestActivityCommon
