...
from nwos.addons.payment_mollie.controllers.main import MollieController
from nwos.addons.payment_mollie.tests.common import MollieCommon
...
class MollieTest(MollieCommon, PaymentHttpCommon):
    ...
    @mute_logger(
        'nwos.addons.payment_mollie.controllers.main',
        'nwos.addons.payment_mollie.models.payment_transaction',
    )
