...
from nwos import _, fields, models, service
...
class PaymentProvider(models.Model):
    ...
    def _build_request_headers(self, *args, **kwargs):
        ...
        nwos_version = service.common.exp_version()['server_version']
        ...
        return {
            ...
            'User-Agent': f'NWOS/{nwos_version} MollieNativeNWOS/{module_version}',
        }
