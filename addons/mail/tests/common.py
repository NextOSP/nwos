...
from nwos import tools, fields
from nwos.addons.base.models.ir_mail_server import IrMail_Server
from nwos.addons.base.tests.common import MockSmtplibCase
from nwos.addons.bus.models.bus import BusBus, json_dump
from nwos.addons.bus.tests.common import BusCase
from nwos.addons.mail.models import mail_thread
from nwos.addons.mail.models.mail_mail import MailMail
from nwos.addons.mail.models.mail_message import MailMessage
from nwos.addons.mail.models.mail_notification import MailNotification
from nwos.addons.mail.models.res_users import ResUsers
from nwos.addons.mail.tools.discuss import Store
from nwos.tests import common, RecordCapturer, new_test_user
from nwos.tools import mute_logger
from nwos.tools.mail import (
    email_normalize, email_normalize_all, email_split, email_split_and_format_normalize, formataddr
)
from nwos.tools.translate import code_translations
...
class MockEmail(common.BaseCase, MockSmtplibCase):
    ...
    def mock_push_to_end_point(self, max_direct_push=5):
        with patch.object(mail_thread, 'push_to_end_point') as patched_push, \
             patch('nwos.addons.mail.models.mail_thread.MAX_DIRECT_PUSH', max_direct_push):
    ...
    def assertNotSentEmail(self, recipients=None, message_id=None):
        ...
        :param message_id:
            ...
            from the a specific message in nwos.
        """
        mails = self._mails
        if message_id:
...
class MailCommon(MailCase):
    ...
    def _activate_multi_lang(cls, lang_code='es_ES', layout_arch_db=None, test_record=False, test_template=False):
        ...
        with mute_logger("nwos.addons.base.models.ir_module", "nwos.tools.translate"):
...
<body>
    ...
    def _setup_push_devices_for_partners(cls, partners, endpoint=None):
        ...
        endpoint = endpoint or "https://test.nwos.com/webpush/user"
...
def freeze_all_time(dt=None):
    ...
    with patch('nwos.sql_db.BaseCursor.now', return_value=dt), freeze_time(dt):
        yield
