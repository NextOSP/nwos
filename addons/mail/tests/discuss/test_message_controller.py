...
from nwos.http import STATIC_CACHE_LONG
from nwos import Command, fields


@nwos.tests.tagged("-at_install", "post_install", "mail_controller")
...
class TestMessageLinks(MailCommon, HttpCase):
    ...
    def test_message_link_by_employee(self):
        ...
        with self.subTest(channel_message=channel_message):
            expected_url = self.base_url() + f'/nwos/action-mail.action_discuss?active_id={channel_message.res_id}&highlight_message_id={channel_message.id}'
