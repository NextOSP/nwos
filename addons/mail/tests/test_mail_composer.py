...
class TestMailComposerForm(TestMailComposer):
    ...
    @mute_logger('nwos.addons.base.models.ir_rule', 'nwos.addons.mail.models.mail_mail')
    @users('employee')
...
class TestMailComposerUI(MailCommon, HttpCase):
    ...
    def test_send_attachment_without_body(self):
        self.start_tour("/nwos/discuss", "create_thread_for_attachment_without_body",login="admin")
