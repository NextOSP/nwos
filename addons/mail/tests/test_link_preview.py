...
from nwos.addons.mail.tools import link_preview
...
class TestLinkPreview(MailCommon):
    ...
    def test_link_preview_ignore_internal_link(self):
        ...
        with patch.object(requests.Session, "get", self._patch_with_og_properties), patch.object(
            ...
            urls = [
                ("http://localhost:8069/", "http://localhost:8069/nwos", 0),
                ("http://localhost:8069/", "http://localhost:8069/nwos/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/web/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/", 1),
                ("http://localhost:8069/", "http://localhost:8069/nwos-experience", 1),
                ("http://localhost:8069/", "http://localhost:8069/chat/5/bFtIfYHRco", 0),
                ("https://www.nwos.com/", "https://www.nwos.com/web", 0),
                ("https://www.nwos.com/", "https://www.nwos.com/nwos", 0),
                ("https://www.nwos.com/", "https://www.nwos.com/nwos/", 0),
                ("https://www.nwos.com/", "https://www.nwos.com/nwos?debug=assets", 0),
                ("https://www.nwos.com/", "https://www.nwos.com/nwos#anchor", 0),
                ("https://www.nwos.com/", "https://www.nwos.com/nwos-experience", 1),
                ("https://www.nwos.com/", "https://www.nwos.com/nwos/1519/tasks/4102866", 0),
                ("https://www.nwos.com/", "https://www.nwos.com/nwos/1519/tasks/4102866", 1),
                ("https://www.nwos.com/", "https://wwwanwos.com/nwos/", 1),
                ("https://www.nwos.com/", "https://www.nwos.com/chat/", 0),
                ("https://www.nwos.com/", "https://www.nwos.com/chat/5/bFtIfYHRco", 0),
                ("https://www.nwos.com/", "https://www.nwos.com/chat/5/bFtIfYHRco", 1),
                ("https://clients.nwos.com/", "https://www.nwos.com/nwos/1519/tasks/4102866", 1),
                ("https://clients.nwos.com/", "https://www.nwos.com/chat/5/bFtIfYHRco", 1),
            ]
    ...
    def test_remove_unused_link_preview(self):
        with (
            ...
            message = self.test_partner.message_post(
                body=Markup(
                    '<a href="https://www.nwos.com/nwos-experience">Nothing link</a> <a href="https://www.nwos.com/nwos-experience-2025">Other Nothing link</a>'
                ),
            ...
            self.test_partner._message_update_content(
                message,
                body=Markup('<a href="https://www.nwos.com/nwos-experience">Nothing link</a>'),
            )
            self.env["mail.link.preview"]._create_from_message_and_notify(message)
            link_preview_count = self.env["mail.message.link.preview"].search_count(
                [("message_id", "=", message.id)]
