...
from nwos import _, api, fields, models, tools, Command
from nwos.addons.base.models.avatar_mixin import get_hsl_from_seed
from nwos.addons.base.models.ir_mail_server import MailDeliveryException
from nwos.addons.mail.tools.discuss import Store
from nwos.addons.mail.tools.web_push import PUSH_NOTIFICATION_TYPE
from nwos.exceptions import AccessError, UserError, ValidationError
from nwos.fields import Domain
from nwos.tools import format_list, email_normalize, html_escape
from nwos.tools.misc import hash_sign, OrderedSet
from nwos.tools.sql import SQL
...
class DiscussChannel(models.Model):
    ...
    def _get_access_action(self, access_uid=None, force_website=False):
        ...
        return {
            "type": "ir.actions.act_url",
            "url": f"/nwos/action-mail.action_discuss?active_id={self.id}",
            "target": "self",
        }
