...
from nwos import _, api, fields, models, modules, SUPERUSER_ID, tools
        ...
        for mail_server_id, alias_domain_id, smtp_from, batch_ids in self._split_by_mail_configuration():
            ...
            try:
                ...
                if raise_exception:
                    ...
                    # exceptions, it is encapsulated into an NWOS MailDeliveryException
        ...
        for mail_id in self.ids:
            ...
            try:
                ...
                if res:  # mail has been sent at least once, no major exception occurred
                    ...
                    # see revid:odo@nwos.com-20120622152536-42b2s28lvdv3odyr in 6.1
                else:
                    mail_vals = {}
                    if failure_reason:
