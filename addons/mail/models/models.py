...
from nwos import api, exceptions, models, tools, _
from nwos.addons.mail.tools.alias_error import AliasError
from nwos.tools import parse_contact_from_email
from nwos.tools.mail import email_normalize, email_split_and_format
from nwos.tools.sql import column_exists
...
class Base(models.AbstractModel):
    ...
    def _message_get_default_recipients(self, with_cc=False, all_tos=False):
        ...
        # ban emails: never propose nwosbot nor aliases
        all_emails = []
    ...
    def _notify_by_email_get_headers(self, headers=None):
        ...
        if not self:
            return headers
        self.ensure_one()
        headers['X-NWOS-Objects'] = f"{self._name}-{self.id}"
