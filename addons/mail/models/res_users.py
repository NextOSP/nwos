...
from nwos import _, api, Command, fields, models, modules, tools
from nwos.exceptions import UserError
from nwos.http import request
from nwos.tools import email_normalize, str2bool
...
class ResUsers(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        help="Policy on how to handle Chatter notifications:\n"
             ...
             "- In NWOS: notifications appear in your NWOS Inbox")
    ...
    _notification_type = models.Constraint(
        ...
        'Only internal user can receive notifications in NWOS',
    )
    ...
    def _init_store_data(self, store: Store):
        ...
        # sudo: res.partner - exposing NWOSBot data is considered acceptable
        nwosbot = self.env.ref("base.partner_root").sudo()
        if not self.env.user._is_public():
            nwosbot = nwosbot.with_prefetch((nwosbot + self.env.user.partner_id).ids)
