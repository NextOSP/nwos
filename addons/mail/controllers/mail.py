...
from nwos.http import STATIC_CACHE, Response, request
from nwos.tools import consteq
from nwos.tools.misc import file_open

from nwos.addons.mail.tools.discuss import add_guest_to_context
...
class MailController(http.Controller):
    ...
    def _redirect_to_messaging(cls):
        url = '/nwos/action-mail.action_discuss'
    ...
    def _redirect_to_record(cls, model, res_id, access_token=None, **kwargs):
        ...
        url = f'/nwos/{model_in_url}/{res_id}?{url_encode(url_params, sort=True)}'
        return request.redirect(url)
    ...
    def export_icon_to_png(self, icon, color='#000', bg=None, size=100, alpha=255, font='/web/static/src/libs/fontawesome/fonts/fontawesome-webfont.ttf', width=None, height=None):
        ...
        if icon.isdigit():
            ...
            if icon in oi_font_char_codes:
                ...
                font = "/web/static/lib/nwos_ui_icons/fonts/nwos_ui_icons.woff"
