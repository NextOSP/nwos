...
export class Thread extends Component {
    ...
    async onClickPreferences() {
        ...
        // `action_get` already targets the current user; keep that res_id if we don't
        // have a user id here, otherwise the form opens in creation mode and saving
        // fails on the required `login` field.
        actionDescription.res_id = this.store.self.main_user_id?.id || actionDescription.res_id;
