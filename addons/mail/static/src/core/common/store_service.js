...
export class Store extends BaseStore {
     ...
     */
    inPublicPage = false;
    nwosbot = fields.One("res.partner");
    ...
    handleClickOnLink(ev, thread) {
        ...
        if (link.classList.contains("o_channel_redirect") && model && id) {
            ...
            if (
                ...
                (browser.location.pathname.startsWith("/nwos") ||
                    browser.location.pathname.startsWith("/nwos"))
            ) {
    ...
    onStarted() {
        this.isNWOSWhiteTheme = cookie.get("color_scheme") !== "dark" || this.inPublicPage;
