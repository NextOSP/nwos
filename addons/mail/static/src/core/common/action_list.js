...
import { Component, onWillUnmount } from "@nwos/owl";
...
class Action extends Component {
    ...
    get hasBtnBg() {
        return (
            this.props.nwosControlPanelSwitchStyle ||
            this.props.hasBtnBg ||
...
export class ActionList extends Component {
    ...
    get hasBtnBg() {
        return this.props.nwosControlPanelSwitchStyle || this.props.hasBtnBg;
    }
}
