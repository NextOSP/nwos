    ...
    steps: () => [
        {
            ...
            async run() {
                const composerService = nwos.__WOWL_DEBUG__.root.env.services["mail.composer"];
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.nwos-editor-editable",
            run: "editor Hello",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.nwos-editor-editable strong:contains(Hello)",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o_mail_composer_message .nwos-editor-editable",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.nwos-editor-editable em:contains(Hello)",
        },
    ],
});
