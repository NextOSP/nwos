/** @nwos-module alias=@web/../tests/utils default=false */

import { __debug__, after, afterEach, expect, getFixture } from "@nwos/hoot";
import { queryAll, queryFirst } from "@nwos/hoot-dom";
 ...
 *
 * @param {import("@nwos/hoot-dom").Target} selector
 ...
 *  element.
 * @property {HTMLElement|NWOSEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when NWOSEnv, special key `target`. See @start
