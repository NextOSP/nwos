...
import { after, before, beforeEach, expect, test } from "@nwos/hoot";
import { press, queryOne } from "@nwos/hoot-dom";
import { animationFrame, enableTransitions } from "@nwos/hoot-mock";
import {
    clickSave,
    contains,
    defineModels,
...
test("HtmlMail save inline html", async function () {
    ...
    await press("enter");
    expect(".nwos-editor-editable").toHaveInnerHTML("<h1> first </h1>");
