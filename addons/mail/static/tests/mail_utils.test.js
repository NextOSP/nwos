...
import { press } from "@nwos/hoot-dom";
...
test("add_link utility function", () => {
    const testInputs = {
        ...
        "https://www.transifex.com/nwos/nwos-11/translate/#fr/lunch?q=text%3A'La+Tartiflette'": true,
        "https://www.transifex.com/nwos/nwos-11/translate/#fr/$/119303430?q=text%3ATartiflette": true,
        "https://tenor.com/view/chỗgiặt-dog-smile-gif-13860250": true,
        "http://www.boîtenoire.be": true,
        "https://github.com/nwos/enterprise/compare/16.0...nwos-dev:enterprise:16.0-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/nwos/enterprise/compare/16.0...16.0-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/nwos/enterprise/compare/16.0...chỗgiặt-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/nwos/enterprise/compare/chỗgiặt...chỗgiặt-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/nwos/enterprise/compare/@...}-voip-fix_demo_data-tsm?expand=1": true,
        "https://x.com": true,
...
test("addLink: utility function and special entities", () => {
    const testInputs = [
        ...
        [
            markup`https://nwos.com/%5B%5D`,
            `<a target="_blank" rel="noreferrer noopener" href="https://nwos.com/%5B%5D">https://nwos.com/%5B%5D</a>`,
        ],
        [
            markup`https://www.nwos.com/appointment/10552?filter_appointment_type_ids=%5B6706%2C%2B6705%2C%2B5292%2C%2B10552%5D`,
            `<a target="_blank" rel="noreferrer noopener" href="https://www.nwos.com/appointment/10552?filter_appointment_type_ids=%5B6706%2C%2B6705%2C%2B5292%2C%2B10552%5D">https://www.nwos.com/appointment/10552?filter_appointment_type_ids=%5B6706%2C%2B6705%2C%2B5292%2C%2B10552%5D</a>`,
        ],
        [
            markup`www.nwos.com`,
            `<a target="_blank" rel="noreferrer noopener" href="https://www.nwos.com/">www.nwos.com</a>`,
        ],
        [
            markup`https://nwos.com/?q=ỗ`,
            `<a target="_blank" rel="noreferrer noopener" href="https://nwos.com/?q=%E1%BB%97">https://nwos.com/?q=ỗ</a>`,
        ],
        ...
        [
            markup`http://999.999.999.999 www.nwos.com`,
            `http://999.999.999.999 <a target="_blank" rel="noreferrer noopener" href="https://www.nwos.com/">www.nwos.com</a>`,
        ],
    ];
...
test("url", async () => {
    ...
    const messageBody = "https://nwos.com?test=~^|`{}[]#";
...
test("url with comma at the end", async () => {
    ...
    await start();
    await openDiscuss(channelId);
    const messageBody = "Go to https://nwos.com, it's great!";
    await insertText(".o-mail-Composer-input", messageBody);
    await press("Enter");
    await contains(".o-mail-Message a:contains(https://nwos.com)");
...
test("url with number in subdomain", async () => {
    ...
    await start();
    await openDiscuss(channelId);
    const messageBody = "https://www.45017478-master-all.runbot134.nwos.com/nwos";
    await insertText(".o-mail-Composer-input", messageBody);
    await press("Enter");
    await contains(
        ".o-mail-Message a:contains(https://www.45017478-master-all.runbot134.nwos.com/nwos)"
    );
});
