...
import { animationFrame, describe, test } from "@nwos/hoot";
import { advanceTime, mockDate } from "@nwos/hoot-mock";
import {
    asyncStep,
    Command,
    getService,
...
test("show typing in member list", async () => {
    ...
    const threadComposerEditor = {
        ...
        editable: document.querySelector(
            ".o-mail-Composer.o-discussApp .o-mail-Composer-html.nwos-editor-editable"
        ),
    };
    ...
    await contains(".o-mail-Message-content:has(:text('HelloWorld!'))");
    await click(".o-mail-Message [title='Edit']");
    await contains(".o-mail-Message .o-mail-Composer-html.nwos-editor-editable");
