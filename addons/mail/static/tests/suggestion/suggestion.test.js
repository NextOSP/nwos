...
import { beforeEach, expect, describe, test } from "@nwos/hoot";
import { Deferred, tick } from "@nwos/hoot-mock";
import {
    asyncStep,
    Command,
    getService,
...
test("[text composer] can @user in restricted (group_public_id) channels", async () => {
    ...
    const [partnerId_1, partnerId_2] = pyEnv["res.partner"].create([
        { email: "testpartner1@nwos.com", name: "TestPartner1" },
        { email: "testpartner2@nwos.com", name: "TestPartner2" },
    ]);
...
test("select @ mention insert mention text in composer", async () => {
    ...
    await htmlInsertText(editor, "@");
    await click(".o-mail-Composer-suggestion strong", { text: "TestPartner" });
    await contains(".o-mail-Composer-html.nwos-editor-editable", { text: "@TestPartner" });
});
...
test("mention a channel thread", async () => {
    ...
    await contains(
        ".o-mail-Composer-html.nwos-editor-editable a.o_channel_redirect:has(i.fa-hashtag)",
        { text: "General" }
    );
    await press("Enter");
    ...
    await click(".o-mail-Composer-suggestion:eq(1)");
    await contains(
        ".o-mail-Composer-html.nwos-editor-editable a.o_channel_redirect:has(i.fa-comments-o)",
        { text: "General > ThreadOne" }
    );
    await press("Enter");
    await contains(".o-mail-Message a.o_channel_redirect:has(i.fa-comments-o)", {
...
test("Mention with @everyone", async () => {
    ...
    await click(".o-mail-Composer-suggestion");
    await contains(".o-mail-Composer-html.nwos-editor-editable", { text: "@everyone" });
    await press("Enter");
    await contains(".o-mail-Message-bubble.o-orange");
    await contains(".o-mail-Message a:contains('@everyone')");
});
...
test("Mention with @-role", async () => {
    ...
    await click(".o-mail-Composer-suggestion");
    await contains(".o-mail-Composer-html.nwos-editor-editable", { text: "@rd-Discuss" });
    await press("Enter");
    await contains(".o-mail-Message a.o-discuss-mention", {
        text: "@rd-Discuss",
    });
