...
Communicate with your colleagues/customers/guest within NWOS.
...
from NWOS itself, and that too with great possibilities. For example,
...
these accounts will be automatically downloaded into your NWOS system. All
POP3/IMAP-compatible servers are supported, included those that require an
encrypted SSL/TLS connection.
This can be used to easily create email-based workflows for many email-enabled NWOS documents, such as:
----------------------------------------------------------------------------------------------------------
...
mailbox-to-NWOS integration. Even better: these documents directly act as mini
conversations synchronized by email. You can reply from within NWOS, and the
...
(technically: Server Actions) to be triggered for each incoming mail.
    ...
    'assets': {
        ...
        'mail.assets_nwos_sfu': [
            'mail/static/lib/nwos_sfu/nwos_sfu.js',
        ],
        'mail.assets_lamejs': [
            'mail/static/lib/lame/lame.js',
        ],
        "mail.assets_message_email": [
            "web/static/lib/nwos_ui_icons/style.css",
        ],
        'mail.assets_public': [
