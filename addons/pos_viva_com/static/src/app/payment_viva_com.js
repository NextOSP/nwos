    ...
    */
    ...
    _call_viva_com(data, action, paymentLine) {
        return this.env.services.orm.silent
            ...
            .catch(this._handleNWOSConnectionFailure.bind(this, paymentLine));
    }

    _handleNWOSConnectionFailure(paymentLine, data = {}) {
        // handle timeout
        ...
        this._show_error(
            _t(
                "Could not connect to the NWOS server, please check your internet connection and try again."
            )
        );
    ...
    handleVivaComStatusResponse(paymentLine, notification) {
        if (!notification) {
            this._handleNWOSConnectionFailure(paymentLine);
            return;
        }
        ...
        return new Promise((resolve) => {
            ...
            const intervalId = setInterval(async () => {
                ...
                try {
                    ...
                    // so that _handleNWOSConnectionFailure is NOT triggered
