...
from nwos.tests.common import tagged, users
...
class TestCRMLead(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.emails_provider_generic = {
            ...
            ('fp@nwos.com', 'fp@nwos.com'),
            ('fp.alias@mail.nwos.com', 'fp.alias@mail.nwos.com'),
        }
        cls.emails_provider_company = {
            ('robert.poilvert@mycompany.com', 'mycompany.com'),
            ('fp@subdomain.nwos.com', 'subdomain.nwos.com'),
        }
        ...
        cls.lead_generic_email_dupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': '"Fabulous Fab" <fp@NWOS.COM>',
                'name': 'Dupe1 of fp@nwos.com (same email)',
                'type': 'lead',
            },
            {
                'email_from': 'FP@nwos.com',
                'name': 'Dupe2 of fp@nwos.com (same email)',
                'type': 'lead',
            },
            # phone_sanitized based
            {
                'email_from': 'not.fp@not.nwos.com',
                'name': 'Dupe3 of fp@nwos.com (same phone sanitized)',
                'phone': '+1 202 555 0123',
                'type': 'lead',
            },
            {
                'email_from': 'not.fp@not.nwos.com',
                'phone': '+1 202 555 0123',
                'name': 'Dupe4 of fp@nwos.com (same phone sanitized)',
                'type': 'lead',
            },
            # same commercial entity
            {
                'name': 'Dupe5 of fp@nwos.com (same commercial entity)',
                'partner_id': cls.test_partners[1].id,
            },
            {
                'name': 'Dupe6 of fp@nwos.com (same commercial entity)',
    ...
    def test_assert_initial_values(self):
        ...
        self.assertEqual(lead_generic.email_domain_criterion, 'fp@nwos.com')
        self.assertEqual(lead_generic.email_normalized, 'fp@nwos.com')
