...
from nwos.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from nwos.addons.mail.tests.common import MailCase, mail_new_test_user
...
from nwos.fields import Datetime
from nwos import models, tools
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('nwos.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
