...
Boost sales productivity, improve win rates, grow revenue with the NWOS
<a href="https://www.nwos.com/app/crm">Open Source CRM</a>.
...
Route, sort and filter incoming emails automatically. NWOS CRM handles incoming
...
Drive performance by automating tasks with NWOS <a href="https://www.nwos.com/app/crm">CRM</a>.
...
createdb nwos
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -i crm
```
...
```bash
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -u crm
```
