...
from nwos.tests.form import Form
...
class TestPeppolParticipant(PeppolConnectorCommon):
    ...
    def test_config_update_email(self):
        ...
        with self._mock_requests([self._mock_update_user()]) as mocks_results:
            ...
            self.assertEqual(
                mocks_results['called']['https://peppol.test.nwos.com/api/peppol/1/update_user']['kwargs']['json']['params']['update_data']['peppol_contact_email'],
                'another@email.be',
            )
