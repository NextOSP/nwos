...
from nwos.addons.account_peppol.exceptions import get_peppol_error_message
from nwos.addons.account_peppol.tools.demo_utils import handle_demo
from nwos.addons.account_peppol.tools.peppol_iap_connector import PEPPOL_PROXY_URLS
...
class Account_Edi_Proxy_ClientUser(models.Model):
    ...
    def _peppol_register_sender_as_receiver(self):
        ...
        # but we need the field for future in case the user decided to migrate away from NWOS
