...
from nwos import api, fields, models, _, service
from nwos.tools import file_open, split_every
from nwos.service.common import exp_version
...
class PosConfig(models.Model):
    ...
    def _compute_selection_pay_after(self):
        ...
        if version_info[-1] == '':
            selection_each_label = f"{selection_each_label} {_('(require NWOS Enterprise)')}"
    ...
    def get_pos_qr_order_data(self):
        url_form = "https://www.nwos.com/app/point-of-sale-restaurant-qr-code"
        table_data = []
