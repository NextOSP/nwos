...
from nwos.addons.pos_self_order.controllers.orders import PosSelfOrderController
...
class TestSelfOrderMobile(SelfOrderCommonTest):
    ...
    def test_self_order_category_with_only_special_products(self):
        ...
        with patch("nwos.addons.point_of_sale.models.pos_config.PosConfig._get_special_products", return_value=prod1 + prod2):
