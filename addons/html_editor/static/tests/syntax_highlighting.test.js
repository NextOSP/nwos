...
import { animationFrame, click, press, queryOne, waitFor } from "@nwos/hoot-dom";
...
test.tags("desktop");
test("should not open the nwos global command bar when pressing ctrl+k inside a syntax-highlighted code block", async () => {
    ...
    // Pressing ctrl+k to open nwos global command bar
    await press(["ctrl", "k"]);
    await animationFrame();
