...
import { animationFrame, press } from "@nwos/hoot-dom";
...
describe("inline code", () => {
    ...
    test.tags("desktop");
    test("should not open the nwos global command bar when pressing ctrl+k inside a inline code element", async () => {
