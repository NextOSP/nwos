...
import { destroy, expect, getFixture } from "@nwos/hoot";
import { queryOne } from "@nwos/hoot-dom";
import { Component, markup, onWillDestroy, xml } from "@nwos/owl";
...
export async function setupWysiwyg(props = {}) {
    ...
    const el = /** @type {HTMLElement} **/ (
        queryOne(`${props.iframe ? ":iframe " : ""}.nwos-editor-editable`)
    );
    if (content) {
...
export function insertTestHtml(innerHtml) {
    ...
    container.classList.add("nwos-editor-editable");
