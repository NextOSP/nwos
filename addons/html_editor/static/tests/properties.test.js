...
import { queryOne } from "@nwos/hoot-dom";
...
test("properties: html", async () => {
    ...
    expect(`[name="properties"] .nwos-editor-editable`).toHaveCount(1);
    expect(`[name="properties"] .nwos-editor-editable .o-paragraph`).toHaveInnerHTML(
        "<b> test </b>"
    );

    setSelection({
        anchorNode: queryOne(`[name="properties"] .nwos-editor-editable .o-paragraph b`),
        anchorOffset: 0,
    });
...
test("properties: html migration", async () => {
    ...
    expect(`[name="properties"] .nwos-editor-editable`).toHaveCount(1);
    expect(`[name="properties"] .nwos-editor-editable a[href*="excalidraw.com"]`).toHaveCount(1);
