...
import { manuallyDispatchProgrammaticEvent } from "@nwos/hoot-dom";
import { tick } from "@nwos/hoot-mock";
...
test("should show replace URL button if link is created by transformation", async () => {
    onRpc("/html_editor/link_preview_external", () => ({
        ...
        og_type: "website",
        og_site_name: "NWOS",
        source_url: "https://nwos.com",
    }));
    const { editor } = await setupEditor(`<p>[]</p>`);
    await insertText(editor, "https://nwos.com ");
