...
export class CollaborationSelectionPlugin extends Plugin {
    ...
    static dependencies = ["history", "collaborationNWOS", "position", "localOverlay"];
    ...
    /**
     * @param {import("./collaboration_nwos_plugin").CollaborationSelection} selection
     */
    ...
    drawPeerSelection({ selection, peerId }) {
        const peerMetadata = this.dependencies.collaborationNWOS.getPeerMetadata(peerId);
        if (!peerMetadata) {
            return;
        }
