...
/**
 * @typedef { Object } CollaborationNWOSShared
 * @property { CollaborationNWOSPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationNWOSPlugin extends Plugin {
    static id = "collaborationNWOS";
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    ...
                    case "ptp_disconnect":
                        ...
                        // todo: to implement
                        // this.nwosEditor.multiselectionRemove(fromPeerId);
                        break;
