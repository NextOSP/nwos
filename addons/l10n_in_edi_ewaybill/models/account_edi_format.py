...
from nwos import models, fields, api, _
from nwos.tools import html_escape
from nwos.exceptions import AccessError
from nwos.addons.iap import jsonrpc
from nwos.addons.l10n_in_edi.models.account_edi_format import DEFAULT_IAP_ENDPOINT, DEFAULT_IAP_TEST_ENDPOINT
    ...
    def _l10n_in_edi_ewaybill_cancel_invoice(self, invoices):
        ...
        if response.get("error"):
            ...
            if "312" in error_codes:
                ...
                invoices.message_post(author_id=nwosbot.id, body=
                    Markup("%s<br/>%s:<br/>%s") %(
