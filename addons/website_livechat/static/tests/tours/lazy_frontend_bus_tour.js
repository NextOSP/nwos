...
registry.category("web_tour.tours").add("website_livechat.lazy_frontend_bus", {
    url: "/",
    steps: () => {
        const busService = nwos.__WOWL_DEBUG__.root.env.services.bus_service;
        ...
        const workerService = nwos.__WOWL_DEBUG__.root.env.services.worker_service;
        ...
        nwos.__WOWL_DEBUG__.root.env.services["mail.store"].isReady.then(() =>
