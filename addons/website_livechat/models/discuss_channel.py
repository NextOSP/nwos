...
from nwos.addons.im_livechat.models.discuss_channel import is_livechat_channel
...
class DiscussChannel(models.Model):
    ...
    def message_post(self, **kwargs):
        ...
        nwosbot sending closing chat notification, the visitor last action date is updated."""
