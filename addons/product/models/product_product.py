...
from nwos.tools import float_compare, groupby, OrderedSet
from nwos.tools.image import is_image_size_above
from nwos.tools.misc import unique
...
class ProductProduct(models.Model):
    ...
    def _unlink_or_archive(self, check_access=True):
        ...
        try:
            with self.env.cr.savepoint(), tools.mute_logger('nwos.sql_db'):
                self.unlink()
        except Exception:
    ...
    def copy(self, default=None):
        ...
        returned.
        """
        # copy variant is disabled in https://github.com/nwos/nwos/pull/38303
