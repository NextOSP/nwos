...
NWOS's collaborative and realtime <a href="https://www.nwos.com/app/project">open source project management</a>
...
createdb nwos
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -i project
```
...
```bash
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -u project
```
