...
import nwos.tests
from nwos.tests import new_test_user


from unittest.mock import patch

from nwos import release
from nwos.addons import __path__ as __addons_path__
from nwos.exceptions import UserError
from nwos.tools import file_open, file_open_temporary_directory, mute_logger
from nwos.tools.translate import TranslationModuleReader


@nwos.tests.tagged('post_install', '-at_install')
class TestImportModule(nwos.tests.TransactionCase):
    ...
    def test_import_zip(self):
        ...
        with self.assertLogs('nwos.addons.base_import_module.models.ir_module') as log_catcher:
            self.import_zipfile(files)
            self.assertIn('INFO:nwos.addons.base_import_module.models.ir_module:module foo: no translation for language fr_FR', log_catcher.output)
        ...
        self.assertEqual(
            ...
            [
                ...
                ('bar', 'baz', r'addons/bar/static/src/js/bar.js', 1, 'code', ('nwos-javascript',), None, 'qux'),
            ]
        )
    ...
    def test_import_zip_invalid_manifest(self):
        ...
        with (
            mute_logger("nwos.addons.base_import_module.models.ir_module"),
    ...
    def test_import_zip_ignore_unexpected_data_extension(self):
        ...
        with self.assertLogs('nwos.addons.base_import_module.models.ir_module') as log_catcher:
            self.import_zipfile(files)
            self.assertIn("INFO:nwos.addons.base_import_module.models.ir_module:module foo: skip unsupported file res.partner.xls", log_catcher.output)
            self.assertIn("INFO:nwos.addons.base_import_module.models.ir_module:Successfully imported module 'foo'", log_catcher.output)
            self.assertFalse(self.env.ref('foo.foo', raise_if_not_found=False))
...
class TestImportModuleHttp(TestImportModule, nwos.tests.HttpCase):
