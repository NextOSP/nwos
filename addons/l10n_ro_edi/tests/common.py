...
class TestROEdiCommon(AccountTestInvoicingCommon):
    ...
    def send_invoice_with_mock(self, invoice, mock_return_value):
        ...
        with patch(
            'nwos.addons.l10n_ro_edi.models.account_move._request_ciusro_send_invoice',
    ...
    def synchronize_with_mock(self, mock_return_value):
        ...
        with patch(
            'nwos.addons.l10n_ro_edi.models.account_move._request_ciusro_synchronize_invoices',
            return_value=mock_return_value,
        ):
