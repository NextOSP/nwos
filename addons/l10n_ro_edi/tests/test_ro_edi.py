...
from nwos.addons.l10n_ro_edi.tests.common import TestROEdiCommon
...
class TestRoEdi(TestROEdiCommon):
    def test_documents_only_deleted_on_validation(self):
        ...
        with patch(
            'nwos.addons.l10n_ro_edi.models.account_move._request_ciusro_fetch_status',
            return_value={"key_download": "DL_AA", "state_status": "nok"},
        ), patch(
            'nwos.addons.l10n_ro_edi.models.account_move._request_ciusro_download_answer',
            return_value={
                "signature": {
