...
from nwos.addons.iot_drivers.tools import certificate, helpers, upgrade, wifi
from nwos.addons.iot_drivers.tools.system import IS_RPI, IS_WINDOWS
from nwos.addons.iot_drivers.websocket_client import WebsocketClient
...
class Manager(Thread):
    ...
    def _send_all_devices(self, server_url=None):
        """This method send IoT Box and devices information to NWOS database
    ...
    def run(self):
        """Thread that will load interfaces and drivers and contact the nwos server
        ...
        if IS_RPI and helpers.get_nwos_server_url():
