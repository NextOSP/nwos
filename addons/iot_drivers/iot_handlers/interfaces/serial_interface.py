...
from nwos.addons.iot_drivers.tools.system import IS_WINDOWS
from nwos.addons.iot_drivers.interface import Interface
...
class SerialInterface(Interface):
    ...
    def get_devices(self):
        ...
        serial_devices = {
            ...
            # RPI 5 uses ttyAMA10 as a console serial port for system messages: nwos interprets it as scale -> avoid it
        }
