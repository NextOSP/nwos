...
from nwos.addons.iot_drivers.browser import Browser, BrowserState
...
from nwos.addons.iot_drivers.tools.helpers import Orientation
...
class DisplayDriver(Driver):
    ...
    def _action_open_kiosk(self, data):
        origin = helpers.get_nwos_server_url()
    ...
    def _action_open_customer_display(self, data):
        ...
        origin = helpers.get_nwos_server_url() or http.request.httprequest.origin
    ...
    def set_orientation(self, orientation=Orientation.NORMAL):
        ...
        subprocess.run(
            ['sed', '-i', f's/HDMI-A-[12]/{self.device_identifier}/', '/home/nwos/.config/labwc/rc.xml'],
            check=False,
        )
