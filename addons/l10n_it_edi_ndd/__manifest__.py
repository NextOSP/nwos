...
Additional module to support the debit notes (nota di debito - NDD) by adding payment method and document types
    ...
    # NWOS19: obsolete - l10n_it_edi now defines l10n_it.document.type, its full
    # document-type dataset (TD01-TD28) and the l10n_it_document_type/payment_method
    # fields on account.move. This module duplicates them, causing a unique-code clash.
    'installable': False,
    'license': 'LGPL-3',
}
