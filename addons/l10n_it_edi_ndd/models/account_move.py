...
from nwos.addons.l10n_it_edi_ndd.models.account_payment_methode_line import L10N_IT_PAYMENT_METHOD_SELECTION
from nwos.addons.l10n_it_edi.models.account_move import get_text
