...
from nwos.tests.common import users, tagged, HttpCase, warmup
...
class TestDiscussFullPerformance(HttpCase, MailCommon):
    ...
    #   1: search res_partner (nwosot ref exists)
    ...
    def _get_init_store_data_result(self):
        ...
        return {
            ...
            "Store": {
                ...
                "nwosbot": self.user_root.partner_id.id,
