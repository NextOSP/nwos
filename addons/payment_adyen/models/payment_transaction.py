...
from nwos import _, api, models, release
from nwos.tools import format_amount

from nwos.addons.payment import utils as payment_utils
from nwos.addons.payment.logging import get_payment_logger
from nwos.addons.payment_adyen import const
        ...
        if event_code == 'AUTHORISATION':
            ...
            if source_tx:
                ...
                if tx and tx.amount != converted_notification_amount:
                    ...
                    # others captures that NWOS was unaware of were done, the amount voided will
