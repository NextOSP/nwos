...
from nwos.addons.l10n_gr_edi.models.l10n_gr_edi_document import _make_mydata_request
from nwos.addons.l10n_gr_edi.models.preferred_classification import (
    ...
    def _l10n_gr_edi_get_pre_error_dict(self):
        ...
        error_action_gr_settings = {
            ...
            'action': {
                ...
                'target': 'self',
                'url': '/nwos/settings#l10n_gr_edi_aade_settings',
            },
        }
