...
import { click, queryAll, queryFirst } from "@nwos/hoot-dom";
...
test("list sorting clickable cell", async () => {
    ...
    const data = {
        sheets: [
            {
                cells: {
                    A1: '=NWOS.LIST.HEADER(1, "foo")',
                    A2: '=NWOS.LIST(1, 1, "foo")',
                },
            },
        ],
        lists: {
        ...
        sheets: [
            {
                cells: {
                    ...
                    B1: "bar",
                    // spill cells
                    A2: "=NWOS.LIST.HEADER(1, A1:B1)",
                    A3: '=NWOS.LIST(1, sequence(2), "foo")',
                },
            },
        ],
        lists: {
