...
export class DashboardLoader {
    ...
    _createSpreadsheetModel(snapshot, revisions = [], currency, translationNamespace) {
        const nwosDataProvider = new NWOSDataProvider(this.env);
        const model = new Model(
            snapshot,
            {
                custom: { env: this.env, orm: this.orm, nwosDataProvider, translationNamespace },
                mode: "dashboard",
        ...
        nwosDataProvider.addEventListener("data-source-updated", () =>
