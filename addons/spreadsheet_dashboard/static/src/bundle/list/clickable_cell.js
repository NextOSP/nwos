...
import { registries, components, readonlyAllowedCommands } from "@nwos/o-spreadsheet";
import { _t } from "@web/core/l10n/translation";

const { clickableCellRegistry } = registries;
const { ClickableCellSortIcon } = components;

readonlyAllowedCommands.add("UPDATE_NWOS_LIST");
...
function sortList(env, position, direction) {
    ...
    env.model.dispatch("UPDATE_NWOS_LIST", {
        listId,
        list: {
            ...definition,
            searchParams: {
