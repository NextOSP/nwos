...
import { EvaluationError } from "@nwos/o-spreadsheet";
...
const NWOS_PARTNER_BALANCE_ARGS = () => {
    const partner_arg = arg("partner_ids (string)", _t("The partner ids (separated by a comma)."));
    return [partner_arg, ...NWOS_RESIDUAL_ARGS()];
};

functionRegistry.add("NWOS.CREDIT", {
...
functionRegistry.add("NWOS.DEBIT", {
...
functionRegistry.add("NWOS.BALANCE", {
...
functionRegistry.add("NWOS.FISCALYEAR.START", {
...
functionRegistry.add("NWOS.FISCALYEAR.END", {
...
functionRegistry.add("NWOS.ACCOUNT.GROUP", {
...
functionRegistry.add("NWOS.BALANCE.TAG", {
