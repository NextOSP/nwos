...
from nwos.addons.website_hr_recruitment.controllers.main import WebsiteHrRecruitment

@nwos.tests.tagged('post_install', '-at_install')
class TestWebsiteHrRecruitmentForm(nwos.tests.HttpCase):
    def test_tour(self):
        ...
        with nwos.tests.RecordCapturer(self.env['hr.applicant']) as capt:
