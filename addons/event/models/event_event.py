...
from nwos import _, api, Command, fields, models, tools
...
from nwos.tools import format_date, format_datetime, format_time, frozendict
from nwos.tools.mail import is_html_empty, html_to_inner_content
...
class EventEvent(models.Model):
    ...
    def get_kiosk_url(self):
        return self.get_base_url() + "/nwos/registration-desk"
