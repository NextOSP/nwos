...
function patchTracking() {
    const { Tracking } = nwos.loader.modules.get('@website_sale/interactions/tracking');
...
if (nwos.loader.modules.has('@website_sale/interactions/tracking')) {
    patchTracking();
} else {
    nwos.loader.bus.addEventListener('module-started', (e) => {
