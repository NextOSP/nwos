...
from nwos import SUPERUSER_ID, api, fields, models
from nwos.exceptions import ValidationError
from nwos.fields import Domain
from nwos.http import request
from nwos.tools import float_is_zero, float_round, urls

from nwos.addons.website_sale import const, utils
...
class ProductFeed(models.Model):
    ...
    def _prepare_gmc_price_info(self, product):
        ...
        # differently than NWOS.
        # Ex: product="Pack of wine (6 bottles)", price=$65.00, uom_name="Pack".
        #   - in nwos: base_unit_count=6.0, base_unit_name="750ml"
    ...
    def _notify_website_manager(self, **kwargs):
        """Send a notification to the website manager using NWOSBot.
