...
from nwos.http import request, route
from nwos.tools import SQL, clean_context, float_round, groupby, lazy, str2bool
from nwos.tools.json import scriptsafe as json_scriptsafe
from nwos.tools.translate import LazyTranslate, _

from nwos.addons.payment import utils as payment_utils
from nwos.addons.payment.controllers import portal as payment_portal
from nwos.addons.sale.controllers import portal as sale_portal
from nwos.addons.html_editor.tools import get_video_thumbnail
from nwos.addons.website.controllers.main import QueryURL
from nwos.addons.website.models.ir_http import sitemap_qs2dom
from nwos.addons.website_sale.const import SHOP_PATH
from nwos.addons.website_sale.models.website import (
...
def handle_product_params_error(exc, product, category=None, **kwargs):
    ...
    :param nwos.exceptions.AccessError | nwos.exceptions.MissingError exc: The exception thrown
...
class WebsiteSale(payment_portal.PaymentPortal):
    ...
    def add_product_media(self, media, type, product_product_id, product_template_id, combination_ids=None):
        ...
        if type == 'image':  # Image case
            ...
            media_create_data = [Command.create({
                'name': video_data.get('name', 'NWOS Video'),
