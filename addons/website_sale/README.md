...
NWOS is an <a href="https://www.nwos.com/app/ecommerce">Open Source eCommerce</a>
...
NWOS's unique *'edit inline'* and building blocks approach makes product pages
...
NWOS's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. NWOS's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As NWOS marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. NWOS proposes
...
SEO tools are ready to use, with no configuration required. NWOS suggests
...
Create new landing pages easily with the NWOS inline editing feature. Send
...
Benefit from the power of NWOS, in your online store: a powerfull tax engine,
...
Everything is integrated with NWOS. No pain, real time.
...
createdb nwos
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -i website_sale
```
...
```bash
./nwos-bin server --addons-path=addons,nwos/addons -d nwos -u website_sale
```
