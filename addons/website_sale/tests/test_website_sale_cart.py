...
from nwos.addons.product.tests.common import ProductVariantsCommon
from nwos.addons.website_sale.controllers.cart import Cart
from nwos.addons.website_sale.controllers.combo_configurator import (
...
from nwos.addons.website_sale.models.product_template import ProductTemplate
...
class TestWebsiteSaleCart(ProductVariantsCommon, WebsiteSaleCommon):
    ...
    def test_checkout_no_delivery_method_available(self):
        ...
        with (
            ...
            patch(
                'nwos.addons.website_sale.models.sale_order.SaleOrder._get_preferred_delivery_method',
