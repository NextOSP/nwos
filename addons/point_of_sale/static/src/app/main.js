...
import { mount, reactive, whenReady } from "@nwos/owl";
...
(async function startPosApp() {
    ...
    if (recoverySessionId && parseInt(recoverySessionId) === nwos.pos_session_id) {
...
function registerServiceWorker() {
    ...
    const urlsToCache = JSON.parse(nwos.urls_to_cache);
