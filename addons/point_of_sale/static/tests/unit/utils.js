...
import { animationFrame, tick, waitFor, waitUntil } from "@nwos/hoot-dom";
import { Deferred } from "@nwos/hoot-mock";
import { MainComponentsContainer } from "@web/core/main_components_container";
import { patch } from "@web/core/utils/patch";
import { onMounted } from "@nwos/owl";
import { expect } from "@nwos/hoot";
...
export const setupPosEnv = async (opts = { setupCashier: true }) => {
    ...
    nwos.pos_session_id = 1;
    nwos.pos_config_id = 1;
    nwos.from_backend = 0;
    nwos.access_token = uuidv4(); // Avoid indexedDB conflicts
    nwos.info = {
