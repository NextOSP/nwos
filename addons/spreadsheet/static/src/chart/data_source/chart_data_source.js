import { NWOSViewsDataSource } from "@spreadsheet/data_sources/nwos_views_data_source";
import { _t } from "@web/core/l10n/translation";
import { GraphModel as ChartModel } from "@web/views/graph/graph_model";
import { Domain } from "@web/core/domain";
import { normalizeNWOSChartType } from "../nwos_chart/chart_type";

export class ChartDataSource extends NWOSViewsDataSource {
    /**
     * @override
...
export function chartTypeToDataSourceMode(chartType) {
    const normalizedChartType = normalizeNWOSChartType(chartType);
    switch (normalizedChartType) {
        case "nwos_bar":
        case "nwos_line":
        case "nwos_pie":
            return normalizedChartType.replace("nwos_", "");
        default:
            return "bar";
    }
}
