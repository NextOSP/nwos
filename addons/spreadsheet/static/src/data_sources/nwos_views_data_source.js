...
/**
 * @typedef {Object} NWOSModelMetaData
 * @property {string} resModel
 * @property {NWOSFields} [fields]
 *
 * @typedef {Object} NWOSModelSearchParams
 * @property {Object} context
 * @property {Array<string>} domain
 */

export class NWOSViewsDataSource extends LoadableDataSource {
    /**
     * @override
     * @param {Object} services
     * @param {Object} params
     * @param {NWOSModelMetaData} params.metaData
     * @param {Object} params.searchParams
     */
    constructor(services, params) {
        super(services);
        /** @type {NWOSModelMetaData} */
    ...
    /**
     * @returns {NWOSFields} List of fields
     */
    getFields() {
     ...
     * @returns {NWOSField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
