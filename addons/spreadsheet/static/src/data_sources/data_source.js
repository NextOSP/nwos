...
import { CellErrorType, EvaluationError } from "@nwos/o-spreadsheet";
import { _t } from "@web/core/l10n/translation";

/**
 * @typedef {import("./nwos_data_provider").NWOSDataProvider} NWOSDataProvider
...
export class LoadableDataSource {
    /**
     * @param {Object} param0
     * @param {NWOSDataProvider} param0.nwosDataProvider
     */
    constructor({ nwosDataProvider }) {
        /** @protected */
    ...
    get _orm() {
        return this.nwosDataProvider.orm;
    }

    get serverData() {
        return this.nwosDataProvider.serverData;
    }
    ...
    async load(params) {
        if (params && params.reload) {
            this.nwosDataProvider.cancelPromise(this._loadPromise);
            this._loadPromise = undefined;
        }
        if (!this._loadPromise) {
            ...
            await this.nwosDataProvider.notifyWhenPromiseResolves(this._loadPromise);
        }
 ...
 * @param {string} model
 * @returns {Promise<import("@spreadsheet").NWOSFields>}
 */
