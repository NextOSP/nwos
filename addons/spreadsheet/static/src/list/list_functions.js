...
import { helpers, registries, EvaluationError } from "@nwos/o-spreadsheet";
...
functionRegistry.add("NWOS.LIST", NWOS_LIST);
functionRegistry.add("NWOS.LIST.HEADER", NWOS_LIST_HEADER);
