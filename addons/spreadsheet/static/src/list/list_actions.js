...
import { astToFormula, helpers } from "@nwos/o-spreadsheet";
...
/**
 * @param {import("@nwos/o-spreadsheet").CellPosition} position
...
/**
 * @param {import("@nwos/o-spreadsheet").CellPosition} position
 * @param {import("@spreadsheet").NWOSGetters} getters
 * @returns {boolean}
 */
export const SEE_RECORD_LIST_VISIBLE = (position, getters) => {
    ...
    return !!(
        ...
        getFirstListFunction(cell.compiledFormula.tokens).functionName === "NWOS.LIST"
    );
};
