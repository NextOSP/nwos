...
import { NWOSCoreViewPlugin } from "@spreadsheet/plugins";
...
export class ListCoreViewPlugin extends NWOSCoreViewPlugin {
    ...
    handle(cmd) {
        switch (cmd.type) {
            ...
            case "SET_GLOBAL_FILTER_VALUE":
                ...
                break;
            case "UPDATE_NWOS_LIST":
            case "UPDATE_NWOS_LIST_DOMAIN": {
            ...
            case "REDO": {
                ...
                const updateCommands = cmd.commands.filter(
                    (cmd) =>
                        cmd.type === "UPDATE_NWOS_LIST_DOMAIN" ||
                        cmd.type === "UPDATE_NWOS_LIST" ||
                        cmd.type === "INSERT_NWOS_LIST"
                );
    ...
    getListFieldFromPosition(position) {
        ...
        const fieldArg = functionName === "NWOS.LIST.HEADER" ? args[1] : args[2];
