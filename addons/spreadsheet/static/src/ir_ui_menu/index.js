...
class BadNWOSLinkError extends EvaluationError {
    constructor(menuId) {
        super(
...
export const spreadsheetLinkMenuCellService = {
    ...
    start(env) {
        function _getIrMenuByXmlId(xmlId) {
            ...
            if (!menu) {
                throw new BadNWOSLinkError(xmlId);
            }
            return menu;
        }

        urlRegistry
            .replace("NWOSMenuIdLink", {
                sequence: 65,
                ...
                createLink(url, label) {
                    ...
                    if (!menu) {
                        throw new BadNWOSLinkError(menuId);
                    }
                    return {
                        url,
                        label,
