...
/**
 *
 * @typedef {import("@spreadsheet").NWOSPivotDefinition} NWOSPivotDefinition
...
export class PivotCoreGlobalFilterPlugin extends NWOSCorePlugin {
    ...
    export(data) {
        for (const id in this.pivots) {
            ...
            data.pivots[id].fieldMatching =
                pivot.type === "NWOS" ? this.pivots[id].fieldMatching : {};
        }
    }
}
