...
import { PivotNWOSCorePlugin } from "./plugins/pivot_nwos_core_plugin";
...
coreTypes.add("UPDATE_NWOS_PIVOT_DOMAIN");

invalidateEvaluationCommands.add("UPDATE_NWOS_PIVOT_DOMAIN");
...
inverseCommandRegistry.add("UPDATE_NWOS_PIVOT_DOMAIN", identity);

export { PivotNWOSCorePlugin, PivotCoreViewGlobalFilterPlugin, PivotUIGlobalFilterPlugin };
