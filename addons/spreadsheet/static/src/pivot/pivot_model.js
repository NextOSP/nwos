...
import { helpers, constants, EvaluationError, SpreadsheetPivotTable } from "@nwos/o-spreadsheet";
...
/**
 * @typedef {import("@nwos/o-spreadsheet").PivotTableColumn} PivotTableColumn
 * @typedef {import("@nwos/o-spreadsheet").PivotTableRow} PivotTableRow
 ...
 */
export class NWOSPivotModel extends PivotModel {
    /**
     * @param {import("@web/env").NWOSEnv} env
     * @param {import("@spreadsheet").NWOSPivotModelParams} params
    ...
    constructor(env, params, services) {
        ...
        /**
         * @type {import("@spreadsheet").NWOSGetters}
         */
    ...
    /**
     * Get the NWOS domain corresponding to the given domain
     * @param {PivotDomain} domain
     */
    ...
    /**
     * @param {import("@nwos/o-spreadsheet").PivotDimension} dimension
