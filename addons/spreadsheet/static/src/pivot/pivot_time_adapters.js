...
import { registries, helpers, constants, EvaluationError } from "@nwos/o-spreadsheet";
...
function boundedNWOSNumberDateAdapter(lower, upper) {
    return {
...
pivotTimeAdapterRegistry.add("week", falseHandlerDecorator(nwosWeekAdapter));
pivotTimeAdapterRegistry.add("quarter", falseHandlerDecorator(nwosQuarterAdapter));

extendSpreadsheetAdapter("day", nwosDayAdapter);
extendSpreadsheetAdapter("year", nwosYearAdapter);
extendSpreadsheetAdapter("day_of_month", boundedNWOSNumberDateAdapter(1, 31));
extendSpreadsheetAdapter("iso_week_number", boundedNWOSNumberDateAdapter(0, 54));
extendSpreadsheetAdapter("month_number", boundedNWOSNumberDateAdapter(1, 12));
extendSpreadsheetAdapter("quarter_number", boundedNWOSNumberDateAdapter(1, 4));
extendSpreadsheetAdapter("day_of_week", nwosDayOfWeekAdapter);
extendSpreadsheetAdapter("hour_number", nwosHourNumberAdapter);
extendSpreadsheetAdapter("minute_number", nwosMinuteNumberAdapter);
extendSpreadsheetAdapter("second_number", nwosSecondNumberAdapter);
extendSpreadsheetAdapter("month", nwosMonthAdapter);
