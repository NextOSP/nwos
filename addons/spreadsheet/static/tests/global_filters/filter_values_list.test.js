...
import { click, edit, queryAllTexts } from "@nwos/hoot-dom";
...
import { Component, onWillUnmount, xml } from "@nwos/owl";
...
test("basic text filter", async function () {
    ...
    const model = new Model({}, { custom: { nwosDataProvider: new NWOSDataProvider(env) } });
