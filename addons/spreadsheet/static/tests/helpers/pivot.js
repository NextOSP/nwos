...
import { NWOSPivot } from "@spreadsheet/pivot/nwos_pivot";
...
async function insertStaticPivot(model, pivotId, params) {
    ...
    if (!(ds instanceof NWOSPivot)) {
        throw new Error("The pivot data source is not an NWOSPivot");
    }
 ...
 * @returns {Promise<{ model: NWOSSpreadsheetModel, env: object, pivotId: string}>}
 */
