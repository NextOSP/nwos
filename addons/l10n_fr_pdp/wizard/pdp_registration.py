...
from nwos import api, fields, models, modules
from nwos.exceptions import UserError, ValidationError, RedirectWarning

from nwos.addons.l10n_fr_pdp.models.res_company import PDP_identifier_re
    ...
    def _compute_warnings(self):
        for wizard in self:
            ...
            if (
                ...
                and not participant_info.get('receiver_on_nwos')
               ):
