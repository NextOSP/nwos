...
from nwos.addons.account_edi_ubl_cii.tests.common import TestUblCiiCommon
...
class TestL10nFrPdpCommon(TestUblCiiCommon, TestAccountMoveSendCommon):
    ...
    def setUpClass(cls):
        ...
        cls.startClassPatcher(patch(
            'nwos.addons.l10n_fr_pdp.models.pdp_flow.PdpFlow._get_pdp_proxy_user',
            return_value=False,
        ))
    ...
    def _send_patched(cls, invoice):
        valid_peppol_verification_state = mock.patch('nwos.addons.l10n_fr_pdp.models.res_partner.ResPartner._get_peppol_verification_state', return_value='valid')
