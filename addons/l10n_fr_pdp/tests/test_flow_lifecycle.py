...
from nwos.addons.l10n_fr_pdp.tests.common import TestL10nFrPdpCommon
...
class TestPdpReportsFlowLifecycle(TestL10nFrPdpCommon):
    ...
    def _run_send_cron(self, date, identifier='FLOW-TEST-001'):
        with patch('nwos.fields.Date.today', return_value=fields.Date.to_date(date)):
            with patch(
    ...
    def test_repeated_cron_does_not_resend_sent_flow(self):
        ...
        with patch('nwos.fields.Date.today', return_value=fields.Date.to_date('2025-09-20')):
            with patch(
                'nwos.addons.l10n_fr_pdp.models.pdp_flow.PdpFlow._send_to_proxy',
