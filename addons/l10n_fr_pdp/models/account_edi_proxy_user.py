...
from nwos.addons.l10n_fr_pdp.models.account_peppol_response import PEPPOL_TO_PDP_STATUS, PDP_STATUSES
from nwos.addons.l10n_fr_pdp.tools.demo_utils import handle_demo
from nwos.addons.l10n_fr_pdp.utils.cdar import _parse_datetime_node as _parse_cdar_datetime_node
...
class AccountEdiProxyClientUser(models.Model):
    ...
    def _get_proxy_urls(self):
        ...
        urls['pdp'] = {
            'prod': 'https://pdp.api.nwos.com',
            'test': 'https://pdp.test.nwos.com',
            'demo': 'demo',
        }
        return urls
