...
from nwos.tools import frozendict, html2plaintext

from nwos.addons.l10n_fr_pdp.models.account_edi_proxy_user import STATUS_TO_PROCESS_CONDITION_CODE_PDP
from nwos.addons.l10n_fr_pdp.models.account_edi_xml_ubl_21_fr import PDP_CUSTOMIZATION_ID
from nwos.addons.l10n_fr_pdp.models.account_peppol_response import NEW_STATUSES
from nwos.addons.l10n_fr_pdp.models.pdp_flow import FLOW_OPEN_STATES_SELECTION, FLOW_SENT_STATES, FLOW_SENT_STATES_SELECTION
from nwos.addons.l10n_fr_pdp.utils import drom_com_territories
