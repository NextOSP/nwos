...
patch(PaymentForm.prototype, {
    ...
    /**
     * Load the JS from the PayPal SDK URL and set an identifier dedicated to NWOS, for PayPal to be
     * able to recognize which transactions are originating from NWOS.
     *
     * @private
    ...
    async _paypalLoadSDK(paypalSDKURL) {
        ...
        [...paypalSDKs].forEach(sdk => {
            sdk.setAttribute('data-partner-attribution-id', 'NWOSInc_SP_EC');
        });
    },
