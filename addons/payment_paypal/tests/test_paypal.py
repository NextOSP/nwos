...
from nwos.addons.payment_paypal.controllers.main import PaypalController
from nwos.addons.payment_paypal.tests.common import PaypalCommon
...
class PaypalTest(PaypalCommon, PaymentHttpCommon):
    ...
    @mute_logger('nwos.addons.payment_paypal.controllers.main')
    ...
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'nwos.addons.payment_paypal.controllers.main.PaypalController'
