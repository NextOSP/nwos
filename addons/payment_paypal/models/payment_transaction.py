...
from nwos.addons.payment_paypal import utils as paypal_utils
from nwos.addons.payment_paypal.const import PAYMENT_STATUS_MAPPING
...
class PaymentTransaction(models.Model):
    ...
    # this field has no use in NWOS except for debugging
