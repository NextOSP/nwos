...
from nwos.addons.payment_paypal import const
...
class PaymentProvider(models.Model):
    ...
    def _build_request_headers(
        ...
        headers = {
            ...
            # PayPal requires a reference specific to NWOS to be able to track NWOS customers.
            'PayPal-Partner-Attribution-Id': 'NWOSInc_SP_EC',
        }
        if idempotency_key:
