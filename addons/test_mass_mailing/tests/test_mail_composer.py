...
from nwos.tests import freeze_time, tagged, users
from nwos.tools import mute_logger

from nwos.addons.test_mail.tests.test_mail_composer import TestMailComposer
...
class TestMailComposerMassMailing(TestMailComposer, common.TestMassMailCommon):
    ...
    @mute_logger('nwos.addons.mass_mailing.models.mailing')
