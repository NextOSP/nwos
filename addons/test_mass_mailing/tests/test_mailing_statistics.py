...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('nwos.addons.mass_mailing.models.mailing', 'nwos.addons.mail.models.mail_mail', 'nwos.addons.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_trace_click(mailing, target_records[0], 'https://www.nwos.be')
        self.gateway_mail_trace_click(mailing, target_records[2], 'https://www.nwos.be')
        self.gateway_mail_trace_click(mailing, target_records[3], 'https://www.nwos.be')
