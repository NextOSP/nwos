...
from nwos.addons.sale_management.tests.common import SaleManagementCommon
from nwos.addons.sale_pdf_quote_builder.controllers.quotation_document import (
...
class TestPDFQuoteBuilder(SaleManagementCommon):
    ...
    def setUpClass(cls):
        ...
        cls.internal_user = cls._create_new_internal_user(login='internal.user@test.nwos.com', groups='sales_team.group_sale_salesman')
    ...
    def test_quotation_document_upload_no_template(self):
        ...
        if 'website' not in self.env:
            ...
            from nwos.addons.http_routing.tests.common import MockRequest  # noqa: PLC0415
    ...
    def _test_custom_content_kanban_like(self):
        ...
        self.start_tour(
            f'/nwos/sales/{self.sale_order.id}',
