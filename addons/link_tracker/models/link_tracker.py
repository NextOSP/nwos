...
from nwos import tools, models, fields, api, _
...
from nwos.tools.mail import validate_url
...
class LinkTracker(models.Model):
    ...
    tracked by NWOS. Clicks are counter on each link. A tracker is linked to
