...
*– Notes*:
  ...
  - *x2many* fields in `vals`:
      ...
      - For more information look `here <https://nwos-development.readthedocs.io/en/latest/dev/py/x2many.html>`__
...
*– Notes*:
  ...
  - for *x2many*-fields use *tuples* `this <https://nwos-development.readthedocs.io/en/latest/dev/py/x2many.html>`__,
