...
from nwos.addons.l10n_sa_edi.tests.common import AccountEdiTestCommon, TestSaEdiCommon
...
class TestSaEdiPos(TestSaEdiCommon):
    ...
    def test_accounting_user_can_read_invoice_with_pos_order(self):
        ...
        with patch(
            'nwos.addons.point_of_sale.models.pos_order.PosOrderLine._is_settle_or_deposit',
...
class TestUi(TestGenericSAEdi):
    ...
    @patch('nwos.addons.l10n_sa_edi.models.account_journal.AccountJournal._l10n_sa_ready_to_submit_einvoices',
    ...
    @patch(
        "nwos.addons.l10n_sa_edi.models.account_journal.AccountJournal._l10n_sa_ready_to_submit_einvoices",
        new=lambda self: True,
    )
...
class TestSAZATCAPosInvoice(TestPoSCommon):
    ...
    def test_generate_pdf_false_runs_zatca_skips_pdf(self):
        ...
        """
        ZATCA_PATCH = (
            'nwos.addons.l10n_sa_edi.models.account_edi_format'
