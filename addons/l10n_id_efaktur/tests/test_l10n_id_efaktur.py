...
from nwos.addons.l10n_id_efaktur.models.account_move import FK_HEAD_LIST, LT_HEAD_LIST, OF_HEAD_LIST, _csv_row, AccountMove
...
class TestIndonesianEfaktur(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref='id'):
        ...
        patch_kode_transaksi = patch('nwos.addons.l10n_id_efaktur_coretax.models.account_move.AccountMove._compute_need_kode_transaksi',
