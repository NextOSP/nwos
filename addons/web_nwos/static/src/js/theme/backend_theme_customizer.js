nwos.define('web_nwos.BackendThemeCustomizer', function (require) {
    "use strict";
    ...
    var BackendThemeCustomizer = Widget.extend({
        template: 'web_nwos.theme_customizer.menu',
...
//            company_settings['preloader_option'] = company_container.find('#preloader_option option:selected').val()
        ...
        _render: function() {
            this.$('.f-theme-customizer-toggler').parent().append(QWeb.render('web_nwos.theme_customizer.panel', this));
            var panelContent = this.$('.f-theme-customizer-content')
            var adminPanel = QWeb.render('web_nwos.theme_customizer.panel.admin', this);
            var userPanel = QWeb.render('web_nwos.theme_customizer.panel.user', this);
            if (session.is_admin) {
