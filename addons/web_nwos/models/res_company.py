...
import os
from nwos import api, models, fields
import base64

XML_ID = "web_nwos._assets_primary_variables"
SCSS_URL = '/web_nwos/static/src/scss/backend_theme_customizer/colors.scss'
...
class ResCompany(models.Model):
    ...
    def write(self, vals):
        ...
        if self:
            for rec in self:
                ...
                url = "/web_nwos/static/src/scss/backend_theme_customizer/colors.scss"
    ...
    def get_values(self):
        ...
        colors = self.env['web_nwos.scss_editor'].get_values(
