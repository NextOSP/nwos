...
from nwos.addons.payment_payumoney.controllers.main import PayUMoneyController
from nwos.addons.payment_payumoney.tests.common import PayumoneyCommon
...
class PayUMoneyTest(PayumoneyCommon, PaymentHttpCommon):
    ...
    @mute_logger('nwos.addons.payment_payumoney.controllers.main')
