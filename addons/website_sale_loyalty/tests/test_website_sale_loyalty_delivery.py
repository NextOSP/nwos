...
from nwos.addons.base.tests.common import DISABLED_MAIL_CONTEXT
...
from nwos.addons.website_sale_loyalty.controllers.cart import Cart
from nwos.addons.website_sale_loyalty.controllers.delivery import WebsiteSaleLoyaltyDelivery
