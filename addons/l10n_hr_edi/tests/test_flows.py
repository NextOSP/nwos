...
from nwos.addons.account.tests.common import PatchRequestsMixin
from nwos.addons.account.tests.test_account_move_send import TestAccountMoveSendCommon
from nwos.addons.l10n_hr_edi.tests.test_hr_edi_common import TestL10nHrEdiCommon
...
class TestHrEdiFlowsMocked(TestL10nHrEdiCommon, TestAccountMoveSendCommon, PatchRequestsMixin):
    ...
    def setUpClass(cls):
        ...
        company.write({
            ...
            'l10n_hr_mer_software_ident': 'Sanwos-001',
