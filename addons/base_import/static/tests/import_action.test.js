import { before, describe, expect, test } from "@nwos/hoot";
import {
    animationFrame,
    drag,
    queryOne,
...
import { useEffect } from "@nwos/owl";
import {
    contains,
    defineActions,
    defineModels,
...
describe("Import view", () => {
    ...
    test("UI before file upload", async () => {
        ...
        expect(browser.location.href).toBe("https://www.hoot.test/nwos/action-2/import");
    ...
    test("drag-and-drop file support", async () => {
        ...
        expect(browser.location.href).toBe(
            "https://www.hoot.test/nwos/action-2/import/imported-records"
        );
    });
    ...
    test("active_model in params is the main model", async () => {
        ...
        expect(browser.location.href).toBe("https://www.hoot.test/nwos/import?active_model=team");
    });
