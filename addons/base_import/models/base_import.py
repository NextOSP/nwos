...
class Base_ImportMapping(models.Model):
    ...
    not match NWOS's field names or labels. This model is used
    ...
    def get_fields_tree(self, model, depth=FIELDS_RECURSION_LIMIT):
        ...
        .. class:: Field
            ...
            .. attribute:: name: str
                ...
                The field's logical (NWOS) name within the scope of
                its parent.
            ...
            .. attribute:: model_name: str
                ...
                Used in the NWOS Field Tooltip on the import view
